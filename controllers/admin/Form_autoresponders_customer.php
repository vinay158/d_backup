...
class Form_autoresponders_customer extends CI_Controller {
	...
	function __construct(){
		...
		$this->controller_name = 'form_autoresponders_customer';
	}
	...
	public function view(){
		...
		{
			$data['title'] = 'Lead Auto Responders';
	...
	public function edit(){
		...
		if(!empty($is_logged_in) && $is_logged_in == true){
			...
			if( $this->uri->segment(4) != NULL ){							 
				$data['title'] = "Edit: Lead Auto Responder";
				...
				$data['form_instances'] = $this->query_model->getbySpecific('tbl_form_modules','customer_auto_responder_id', $data['details']->id);
	...
	$is_logged_in = $this->session->userdata('is_logged_in');
		if(!empty($is_logged_in) && $is_logged_in == true)
		{
		$data['title'] = "Add: Lead Auto Responder";
