...
class Sparkpost_mail extends CI_Controller {
	...
	public function index(){
		...
		if(!empty($is_logged_in) && $is_logged_in == true){
			...
			$requestData = array('search_url' =>'metrics/deliverability/template?from=2021-05-01T08:00&metrics=count_sent,count_unique_confirmed_opened,count_accepted,count_bounce,count_targeted,count_injected,count_rejected&limit=100&order_by=count_injected');
