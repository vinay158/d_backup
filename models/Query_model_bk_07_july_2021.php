...
public function checkActiveCampaignContactExists($activeCampaign, $email){
	...
	public function replaceAutoResponderVaribles($content, $formData, $extraContentArr){
		...
		$view_message_link = (isset($formData['twilio_msg_user_id']) && !empty($formData['twilio_msg_user_id'])) ? base_url().'admin/twilio_sms_messenger?kanban_user_id='.$formData['twilio_msg_user_id'] : '';
					...
					if(!empty($twilio_user_id)){
						...
						/******** SEND ADMIN SMS ****/
							...
							if(!empty($admin_twilio_sms_flows)){
								...
								$insertSMSData['sms_users_id'] = $twilio_user_id;
								$insertSMSData['message'] = $admin_msg_template;
										...
										foreach ($messages as $msg) {
											...
											if(empty($msg_exit)){
												...
												if($msg->author != "Dojo Admin"){
													...
													$message = $msg->body.' '.base_url().'admin/twilio_sms_messenger?kanban_user_id='.$twilio_user->id;
												}
