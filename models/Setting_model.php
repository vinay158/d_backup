...
class Setting_model extends CI_Model{	
	...
	function updateSetting(){
		...
		$front_layout_type = (isset($_POST['front_layout_type']) && !empty($_POST['front_layout_type']) )?$_POST['front_layout_type']: 'default_layout';
		
	//	$school_owner_name = (isset($_POST['school_owner_name']) && !empty($_POST['school_owner_name']) )?$_POST['school_owner_name']: '';
