...
public function getNewNotification(){
	...
	if($twilio_chat_api_is_active == 1){
		...
		if(!empty($single_messages)){
			foreach($single_messages as $message){
				...
				$message_nofitications[$msg_created] = $message;
			}
		}
	...
	if(!empty($message_nofitications)){
		krsort($message_nofitications);
	}
	
	
	//echo '<pre>message_nofitications'; print_r($message_nofitications); die;
	//echo '<pre>';print_r($data); die;
	return $message_nofitications;
