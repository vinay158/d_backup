...
<div class="form-light-holder  d-md-flex  dual_input" style="padding-bottom:30px;">
	<div class="adsUrl  form-group">
		<h1>Category</h1>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	<?php if(!empty($details->program_cat_image)){ 
			echo "<a href='javascript:void(0);'  class='deleteOtherImages' field_name='program_cat_image'  number='".$details->id."'>Delete image</a>";
			}
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->program_cat_image_alt_text); ?>" name="program_cat_image_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
<div class="form-light-holder">
...
<div class="form-light-holder">
	...
	<input type="text" name="program_cat_img_top_spacing" id="program_cat_img_top_spacing" class="field  img_top_spacing" placeholder=""  style="width: 7%" value="<?php echo $this->query_model->getStrReplaceAdmin($details->program_cat_img_top_spacing);?>"/> <span style="font-size:15px"><strong>px</strong></span><br/>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	<?php if(!empty($details->featured_program_img)){ 
			echo "<a href='javascript:void(0);'  class='deleteOtherImages' field_name='featured_program_img'  number='".$details->id."'>Delete image</a>";
			}
	?>	
		<div>
	<h1 style="padding-top: 5px;">Image alt text</h1>
	<input value="<?php echo $details->featured_program_img_alt_text; ?>" name="featured_program_img_alt_text" id="" class="field" placeholder="image alt text" type="text">
	</div>
</div>
</div>
...
<div class="form-light-holder">
	...
	<h1>Landing Page Url</h1>
		<input type="text" value="<?php echo $this->query_model->getStrReplaceAdmin($details->landing_page_url);?>" name="landing_page_url" class="field landing_page_url" placeholder="Enter Url here" />
...
<div class="form-light-holder">
	...
	<textarea type="text" id="ckeditor_mini_question_headline" name="question_headline" class="field ckeditor" style="width:98%"><?php echo (!empty($details) && !empty($details->question_headline)) ? $details->question_headline : ''; ?></textarea>
</div>
</div>
...
<div class="form-light-holder">
	...
	<label class="rdiobox">
	<input type="radio" class="header_image_video" name="header_image_video" value="image" <?php if(!empty($details) && $details->header_image_video == 'image'){ echo 'checked=checked'; } elseif(empty($details->header_image_video)){  echo 'checked=checked'; } ?>  /> <span>Image</span></label>
	
	<label class="rdiobox">
	<input type="radio" class="header_image_video" name="header_image_video" value="video" <?php if(!empty($details) && $details->header_image_video == 'video'){ echo 'checked=checked'; }?> /><span> Video</span></label>
...
<div class="form-light-holder" style="overflow:auto;">
		...
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->header_image_alt_text); ?>" name="header_image_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->body_image_alt_text); ?>" name="body_image_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
<div class="form-light-holder">
	<h1> Color Overlay And Opacity  Picker</h1>
...
<div class="form-light-holder">
	<h1>Headline #1</h1>
	<input type="text" name="benefits_headline_1" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_headline_1);?>" class="field" style="width:98%">
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_image_1_alt_text); ?>" name="benefits_image_1_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder">
	<h1>Headline #2</h1>
	<input type="text" name="benefits_headline_2" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_headline_2);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_image_2_alt_text); ?>" name="benefits_image_2_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>

<div class="form-light-holder">
	<h1>Headline #3</h1>
	<input type="text" name="benefits_headline_3" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_headline_3);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_image_3_alt_text); ?>" name="benefits_image_3_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="page-section" id="videorowsection">
	...
	<div class="form-light-holder">
		<h1>Video Title</h1>
		<input type="text" name="video_title" value="<?php echo $this->query_model->getStrReplaceAdmin($details->video_title);?>" class="field" style="width:98%">
	</div>
	<div class="form-light-holder">
...
<div class="form-light-holder">
	...
	<input type="text" name="action_title" value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_title);?>" class="field" style="width:98%">
</div>
...
<div class="form-light-holder">
	<h1>Title #1</h1>
	<input type="text" name="action_headline_1" value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_headline_1);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Description #1</h1>
	<input type="text" name="action_desc_1" value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_desc_1);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Image Link Url #1</h1>
	<input type="text" name="action_link_url_1" value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_link_url_1);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_image_1_alt_text); ?>" name="action_image_1_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder">
	<h1>Title #2</h1>
	<input type="text" name="action_headline_2" value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_headline_2);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Description #2</h1>
	<input type="text" name="action_desc_2" value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_desc_2);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Image Link Url #2</h1>
	<input type="text" name="action_link_url_2" value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_link_url_2);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_image_2_alt_text); ?>" name="action_image_2_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>

<div class="form-light-holder">
	<h1>Title #3</h1>
	<input type="text" name="action_headline_3" value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_headline_3);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Description #3</h1>
	<input type="text" name="action_desc_3" value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_desc_3);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Image Link Url #3</h1>
	<input type="text" name="action_link_url_3" value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_link_url_3);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->action_image_3_alt_text); ?>" name="action_image_3_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder">
	<h1>Heading  Title</h1>
	<input type="text" name="headling_title" value="<?php echo $this->query_model->getStrReplaceAdmin($details->headling_title);?>" class="field" style="width:98%">
</div>
...
<div class="form-light-holder">
	<h1>Headline #1</h1>
	<textarea type="text" id="ckeditor_mini_headline1" name="headling_headline_1" class="field ckeditor" style="width:98%"><?=$details->headling_headline_1;?></textarea>
</div>
...
<div class="form-light-holder">
	<h1>Headline #2</h1>
	<textarea type="text" id="ckeditor_mini_headline2" name="headling_headline_2" class="field ckeditor" style="width:98%"><?=$details->headling_headline_2;?></textarea>
</div>


<div class="form-light-holder">
	<h1>Headline #3</h1>
	<textarea type="text" id="ckeditor_mini_headline3" name="headling_headline_3" class="field ckeditor" style="width:98%"><?=$details->headling_headline_3;?></textarea>
</div>
...
<div class="form-light-holder">
	...
	<input type="text" name="statistics_title" value="<?php echo $this->query_model->getStrReplaceAdmin($details->statistics_title);?>" class="field" style="width:98%">
</div>
...
<div class="form-light-holder">
	<h1>Title #1</h1>
	<input type="text" name="statistics_headline_1" value="<?php echo $this->query_model->getStrReplaceAdmin($details->statistics_headline_1);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Description #1</h1>
	<input type="text" name="statistics_desc_1" value="<?php echo $this->query_model->getStrReplaceAdmin($details->statistics_desc_1);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->statistics_image_1_alt_text); ?>" name="statistics_image_1_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder">
	<h1>Title #2</h1>
	<input type="text" name="statistics_headline_2" value="<?php echo $this->query_model->getStrReplaceAdmin($details->statistics_headline_2);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Description #2</h1>
	<input type="text" name="statistics_desc_2" value="<?php echo $this->query_model->getStrReplaceAdmin($details->statistics_desc_2);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->statistics_image_2_alt_text); ?>" name="statistics_image_2_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>

<div class="form-light-holder">
	<h1>Title #3</h1>
	<input type="text" name="statistics_headline_3" value="<?php echo $this->query_model->getStrReplaceAdmin($details->statistics_headline_3);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Description #3</h1>
	<input type="text" name="statistics_desc_3" value="<?php echo $this->query_model->getStrReplaceAdmin($details->statistics_desc_3);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->statistics_image_3_alt_text); ?>" name="statistics_image_3_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder">
	...
	<input type="text" name="benefits_2_title" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_2_title);?>" class="field" style="width:98%">
</div>
...
<div class="form-light-holder">
	<h1>Title #1</h1>
	<input type="text" name="benefits_2_headline_1" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_2_headline_1);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Description #1</h1>
	<input type="text" name="benefits_2_desc_1" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_2_desc_1);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_2_image_1_alt_text); ?>" name="benefits_2_image_1_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder">
	<h1>Title #2</h1>
	<input type="text" name="benefits_2_headline_2" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_2_headline_2);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Description #2</h1>
	<input type="text" name="benefits_2_desc_2" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_2_desc_2);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_2_image_2_alt_text); ?>" name="benefits_2_image_2_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>

<div class="form-light-holder">
	<h1>Title #3</h1>
	<input type="text" name="benefits_2_headline_3" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_2_headline_3);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder">
	<h1>Description #3</h1>
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_2_image_3_alt_text); ?>" name="benefits_2_image_3_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->white_stripe2_image_alt_text); ?>" name="white_stripe2_image_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
</div>
...
<div class="form-light-holder">
	...
	<input type="text" name="benefits_3_title" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_3_title);?>" class="field" style="width:98%">
</div>
...
<div class="form-light-holder">
	<h1>Title #1</h1>
	<input type="text" name="benefits_3_headline_1" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_3_headline_1);?>" class="field" style="width:98%">
</div>
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_3_image_1_alt_text); ?>" name="benefits_3_image_1_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder">
	<h1>Title #2</h1>
	<input type="text" name="benefits_3_headline_2" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_3_headline_2);?>" class="field" style="width:98%">
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_3_image_2_alt_text); ?>" name="benefits_3_image_2_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>

<div class="form-light-holder">
	<h1>Title #3</h1>
	<input type="text" name="benefits_3_headline_3" value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_3_headline_3);?>" class="field" style="width:98%">
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<label class="custom-file-label" for="customFile">Choose file</label>
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $this->query_model->getStrReplaceAdmin($details->benefits_3_image_3_alt_text); ?>" name="benefits_3_image_3_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
</div>
...
<div class="form-light-holder">
	...
	<textarea type="text" id="ckeditor_mini_opt1_title" name="opt1_title" class="field ckeditor" style="width:98%"><?php echo (!empty($details) && !empty($details->opt1_title)) ? $details->opt1_title : ''; ?></textarea>
</div>
<div class="form-light-holder">
...
<div class="form-light-holder">
	...
	<input type="text" value="<?php echo (!empty($details) && !empty($details->opt1_submit_btn_text)) ? $details->opt1_submit_btn_text : ''; ?>" name="opt1_submit_btn_text" id="" class="field" placeholder=""  style="width: 98%"/>
</div>
...
<div class="form-light-holder">
	...
	<h1>Opt-In Title</h1>
	<input type="text" value="<?php echo (!empty($details) && !empty($details->opt_2_title)) ? $this->query_model->getStrReplaceAdmin($details->opt_2_title) : ''; ?>" name="opt_2_title" id="" class="field" placeholder=""  style="width: 98%"/>
</div>

<div class="form-light-holder">

	<h1>Opt-In Text</h1>
	<input type="text" value="<?php echo (!empty($details) && !empty($details->opt_2_text)) ? $this->query_model->getStrReplaceAdmin($details->opt_2_text) : ''; ?>" name="opt_2_text" id="" class="field" placeholder=""  style="width: 98%"/>
</div>
...
<div class="form-light-holder">
		<h1>Meta Title</h1>
			<input type="text" value="<?php echo $this->query_model->getStrReplaceAdmin($details->meta_title)?>" name="meta_title" id="meta_title" class="field" placeholder="Meta title" style="width: 98%"/>
	</div>
 ...
 <div id="popupDeleteItem" class="modal">
      <div class="modal-dialog modal-dialog-centered sortable-box" role="document">
        <div class="modal-content modal-content-demo">
          ...
          <div class="modal-footer">
            <a href="javascript:void(0)" class="btn btn-indigo popup_delete_btn">Delete</a>
          </div>
		  </form>
        </div>
      </div><!-- modal-dialog -->
