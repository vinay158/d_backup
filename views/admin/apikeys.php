...
<div class="az-content-body-left advanced_page custom_full_page" >
	<div class="az-content-header d-block d-md-flex">
		<div class="az-dashboard-one-title">
			<div>
			  <h2 class="az-dashboard-title">Facebook API</h2>
			</div>
...
<div class="mb-3 main-content-label">Facebook API</div>
...
<div class="mb-3 main-content-label">Youtube API</div>
<div class="form-light-holder  d-md-flex  dual_input">
	<div class="adsUrl form-group">
...
<div class="mb-3 main-content-label">Google Plus API</div>
<div class="form-light-holder  d-md-flex  dual_input">
	<div class="adsUrl form-group">
...
<div class="mb-3 main-content-label">Twitter API</div>
<div class="form-light-holder   d-md-flex  dual_input">
	<div class="adsUrl form-group">
