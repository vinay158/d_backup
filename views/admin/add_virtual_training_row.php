...
<div class="az-content-body-left advanced_page custom_full_page" >
	<div class="az-content-header d-block d-md-flex">
		<div class="az-dashboard-one-title">
			<div>
			  <h2 class="az-dashboard-title">Add: Virtual Training Class Type</h2>
			</div>
...
<div class="mb-3 main-content-label page_main_heading">Add: Virtual Training Class Type</div>
...
<div class="form-light-holder">
	...
	<input type="text" value="" name="class_name" id="" class="field full_width_input" placeholder=""  style="" required/>
...
<div class="form-light-holder">
	...
	<input type="text" value="" name="ages" id="" class="field full_width_input" placeholder=""  style="" />
...
<div class="form-light-holder embed_video">
	...
	<textarea name="embed_video_text"  id="embed_video_text"  class="ckeditor"></textarea>
</div>	


<div class="form-light-holder">
	<span class="field_title">Instructions Title</span>
	<input type="text" value="Start Your Warm Up Before Class Starts" name="instructions_title"  class="field full_width_input" placeholder=""  style=""/>
</div>
<div class="form-light-holder">
	<span class="field_title">Instructions description</span>
	<textarea type="text" name="instructions_description" id="instructions_description" class="field ckeditor full_width_input" placeholder=""  style=""/>Class will load in the space below, at the posted date & times. Do your warm-ups as you wait.</textarea>
</div>
...
<div class="form-light-holder">
	...
	<div class="row row-xs align-items-center">
		...
		<div class="row mg-t-10">
			<div class="col-lg-5">
				<input type="text" value="" name="weekDays[<?php echo $day; ?>][time]" id="" class="field opreationHoursInput" placeholder="">
			</div><!-- col-3 -->
			<div class="col-lg-7 mg-t-20 mg-lg-t-0">
				 <label class="ckbox">
					<input type="checkbox" name="weekDays[<?php echo $day; ?>][no_classes]" value="hide"><span> Not available 
	</span>
            </label>
			</div><!-- col-3 -->
			</div>
...
<div class="form-light-holder" style="display:none">
	...
	<textarea name="live_class_embed"  id="live_class_embed"  class="ckeditor"></textarea>
</div>	
