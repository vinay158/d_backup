...
<div id="deploy_holder">
    ...
    <div style="float:left;">
    	<h1>Date</h1>
		<input type="text" value="" name="date1[]" required class="form-control  multiple_dates" placeholder="mm/dd/yyyy" maxlength="10" style="width: 200px; margin: 0;"/>
