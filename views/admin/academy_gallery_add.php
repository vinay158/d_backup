...
<div class="form-light-holder  d-md-flex  dual_input">
	...
	<h1>Section Type</h1>
	<select name="week_academy_id" id="week_academy_id" class="field" required>
	<option value="">-Select Section-</option>
	<?php foreach($week_academy_pages as $week_academy_page): ?>
	<option <?php if($this->uri->segment(5) == $week_academy_page->id) echo "selected='selected'"; ?> value="<?=$week_academy_page->id?>"><?=$week_academy_page->title?></option>
		<?php endforeach;?>
	</select>
