...
<!--<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyDx7tovEzSELY1D8ZZyAPAMGfk1okpjIqw"></script>-->

<!--
<script src="<?php echo base_url() ?>assets_admin/js/google-places.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyA_ClFBOg08eWAFemb7iM0uSNFplaqoIjM"></script>


<script>
    jQuery(document).ready(function() {
        $("#google-reviews").googlePlaces({
            placeId: 'ChIJ9ahCmLyCf4gRxPbeAbuzetg',
            render: ['reviews'],
            min_rating: 1,
            max_rows: 5
        });
...
<div id="google-reviews">test</div>-->
            ...
            <div class="card card-dashboard-twentyfive keyword-bar card-body newProspects">
				...
				<style>
					...
					<li class="new_lead_<?php echo $lead->kanban_status_id.'_'.$lead->id; ?>">
						...
						<div class="heading"><?php echo !empty($lead->name) ? $lead->name : '&nbsp;' ?></div>
	...
	<div class="az-content-body-right  <?php echo ($this->session->userdata['user_level'] != 1) ? 'not_admin_dashboard_page' : ''; ?>">
          ...
          <div class="az-media-list-reviews">
            <div class="media">
              <div class="az-img-user"><img src="<?php echo base_url().'assets_admin/img/lead_blank_profile_img.png'; ?>" alt=""></div>
              <div class="media-body">
