...
<script>
	$(document).ready(function(){
		...
		CKEDITOR.replace(  'ckeditor_full',
				...
				<?php if(empty($items)){ ?>
					CKEDITOR.replace(  'dojocart_item_desc_1',
									{  customConfig : 'config.js' }
						);
				<?php } ?>
    ...
    <div class="az-content az-content-app az-content-contacts pd-b-0">
      <div class="container">
		...
		<?php $page_url = ''; ?>
          <div id="azContactList" class="az-contacts-list">
			...
			<a href="<?php echo $page_url; ?>#PaymentTypes" class="az-contact-item">
              <div class="az-contact-body">
                <h6>Payment Setting & Dojocart Items</h6>
              </div>
            </a>
        ...
        <div class="az-content-body az-content-body-contacts">
				...
				<div class="az-mail-header">
            <div>
              <h4 class="az-content-title mg-b-5">Edit DojoCart:  <?php echo str_replace('_',' ',$deatail->template); ?> Template</h4>
            </div>
...
$(window).load(function(){
	...
	<?php if(!empty($items)){ ?>
		...
		for(var i = 1; i <= items; i++) {
			var exit_stand_page_name = 'dojocart_item_desc_'+i;
...
<div class="form-light-holder">
	...
	<input type="text" value="<?php echo $deatail->slug; ?>" name="slug" id="slug" class="field"/><br/>
...
<div class="form-light-holder">
 ...
 <div class="form-light-holder">
		...
		<div id="AddMoreFeatures">
			...
			&nbsp; &nbsp; <a feature="<?php echo $feature; ?>" number="<?= $i ?>" href="javascript:void(0)" class="delete_features " > <i class="fa fa-times" ></i> </a>
			<br>
...
<div class="mb-3 main-content-label">Payment Setting &  Dojocart Items</div>
<div class="form-light-holder">
...
<div class="form-light-holder salestax_required">
		...
		<h1 class="inline">Add Sales Tax On Total?</h1>
		<input type="hidden" value="<?= $deatail->sales_taxable ;?>" name="sales_taxable" class="salestax_hidden_cb" />
</div>



		<div class="form-light-holder manage-pricerow tax_hide_show">
		<h1 class="inline displayNone">Product Price (<?php echo $this->query_model->getSiteCurrencyTypeForAdmin() ?>)</h1>
		<div class="price-validate displayNone">
...
<div class="form-light-holder multi_item_salestax_required">
		<a id="status" class="multi_item_salestax_checkbox <?php if($deatail->multi_item_sales_taxable == 1) echo "check-on"; else echo "check-off"; ?>"></a>
		<h1 class="inline">Add Sales Tax On Multi Items?</h1>
		<input type="hidden" value="<?= $deatail->multi_item_sales_taxable ;?>" name="multi_item_sales_taxable" class="multi_item_salestax_hidden_cb" />
</div>
		<div class="form-light-holder showquantity_required displayNone">
...
<div class="form-light-holder item_required ">
		<a id="status" class="item_checkbox <?php if($deatail->dojocart_item == 1) echo "check-on"; else echo "check-off"; ?>"></a>
		<h1 class="inline">Add Dojocart Item? </h1>
		<input type="hidden" value="<?= $deatail->dojocart_item ;?>" name="dojocart_item" class="item_hidden_cb" />
</div>
<div id="item_option" class="">
<div class=""><h3><a href="javascript:void(0);" class="btn btn-outline-light AddMoreItem">Add New Item</a></h3></div>
...
<div>
<a href="javascript:void(0)" class="delete_item delete_image_btn_new" number="<?=$item->id?>">Delete Item #<?= $a ?></a>
<h1><b>Item #<?= $a ?></b></h1>
</div>

	<div class="form-light-holder">
	<h1> Item #<?php echo $a; ?> Title</h1>
	<input type="text" value="<?=$item->item_title?>" name="dojocartItem[<?php echo $a; ?>][item_title]" id="item_title" class="field full_width_input" placeholder=""/>	
</div>

<div class="form-light-holder manage-pricerow">
	<h1> Item #<?php echo $a; ?> Price</h1>
	<div class="price-validate">
	<?php echo $this->query_model->getSiteCurrencyTypeForAdmin() ?><input type="text" value="<?=$item->item_price?>" name="dojocartItem[<?php echo $a; ?>][item_price]" id="item_price" class="field item_price" number="<?php echo $a; ?>" placeholder="Enter Price" style="width:100px"/>
	<div class="ErrorMessage ErrorMessage_up_price1"></div>
	</div>	
	<div class="price-validate multi_item_tax_hide_show">
	<h1 style="padding-left: 10px;">Sales Tax (%)</h1>
		<input type="text" value="<?=$item->sales_tax?>"  name="dojocartItem[<?php echo $a; ?>][sales_tax]" id="sales_tax" class="field sales_tax_main" number="<?php echo $a; ?>" placeholder="%" style="width:100px; margin-left: 10px;" /><div class="ErrorMessage ErrorMessage_sales_tax_main1"></div>
	</div>
...
<div class="form-new-holder">
	<h1>Item #<?php echo $a; ?> Description</h1>
		
	<textarea type="text" value="" name="dojocartItem[<?php echo $a; ?>][item_description]" id="dojocart_item_desc_<?php echo $a; ?>" class="field" placeholder="" /><?=$item->item_description?></textarea>
</div>
</div>
...
<div class="form-light-holder">
	<h1><b>Item #1</b></h1>
	<h1> Item #1 Title</h1>
	<input type="text" value="" name="dojocartItem[1][item_title]" id="item_title" class="field full_width_input" placeholder=""/>	
</div>

<div class="form-light-holder manage-pricerow">
	<h1> Item #1 Price</h1>
	<div class="price-validate">
	<?php echo $this->query_model->getSiteCurrencyTypeForAdmin() ?><input type="text" value="" name="dojocartItem[1][item_price]" id="item_price" class="field item_price" number="1" placeholder="Enter Price" style="width:100px"/>
	<div class="ErrorMessage ErrorMessage_up_price1"></div>
	</div>	
	<div class="price-validate multi_item_tax_hide_show">
	<h1 style="padding-left: 10px;">Sales Tax (%)</h1>
		<input type="text" value=""  name="dojocartItem[1][sales_tax]" id="sales_tax" class="field sales_tax_main" number="1" placeholder="%" style="width:100px; margin-left: 10px;" /><div class="ErrorMessage ErrorMessage_sales_tax_main1"></div>
	</div>
...
<div class="form-new-holder">
	<h1>Item #1 Description</h1>
		
	<textarea type="text" value="" name="dojocartItem[1][item_description]" id="dojocart_item_desc_1" class="field" placeholder="" /></textarea>
</div>
</div>
<?php } ?>
...
<div id="upsale_option" class="displayNone">
...
<div class="form-light-holder">
	...
	<input type="text" value="<?php echo $this->query_model->getStrReplaceAdmin($upsell_opt->up_title); ?>" name="data[<?= $a ?>][up_title]" id="up_title" class="field" placeholder="" style="width:40%"/>
</div>	
<div class="form-light-holder manage-pricerow">
...
<div class="form-light-holder">
	...
	<input type="text" value="<?php echo $this->query_model->getStrReplaceAdmin($upsell_opt->yes)?>" name="data[<?= $a ?>][yes]" id="yes" class="field" placeholder="" style="width:40%"/>	
</div>
<div class="form-light-holder">
	<h1>Upsell # <?= $a ?> “No Thank You! Text” Description</h1>
	<input type="text" value="<?php echo $this->query_model->getStrReplaceAdmin($upsell_opt->no)?>" name="data[<?= $a ?>][no]" id="no" class="field" placeholder="" style="width:40%"/>	
</div>
	<?php 
			$a++; 
		}
...
$(document).ready(function(){
	...
	var dojocart_item = '<?php echo $deatail->dojocart_item; ?>';
	var sales_taxable = '<?php echo $deatail->sales_taxable; ?>';
	var multi_item_sales_taxable = '<?php echo $deatail->multi_item_sales_taxable; ?>';
...
// Upsale Option hide/show
	...
	if(dojocart_item == 1){
		$('#item_option').show();
		$('#item_price').attr('required', 'required');
	...
	if(multi_item_sales_taxable == 1){
		$('.multi_item_tax_hide_show').show();

	}else{
		$('.multi_item_tax_hide_show').hide();	
	}
	...
	$(".delete_item").click(function(){
		...
		var item_id=$(this).attr('number');
		var dojo_cart_id = $('#dojo_cart_id').val();

		
		$.ajax({ 					
		type: 'POST',						
		url: 'admin/dojocart/delete_item',						
...
// kz 22-04-2019
$(".item_required .item_checkbox").click(function(){
		if($(this).hasClass("check-on")){
			$(this).removeClass("check-on");
			$(this).addClass("check-off");
			$(this).parents(".form-light-holder").children(".item_hidden_cb").val("0");
			$('#item_price').attr('required', false);
			$('#item_option').hide();
			//var show_price = 0;
		...
		else
		{
			$(this).removeClass("check-off");
			$(this).addClass("check-on");
			$(this).parents(".form-light-holder").children(".item_hidden_cb").val("1");
			$('#item_option').show();
			$('#item_price').attr('required', 'required');
			//var show_price = 1;
		}
...
$(".salestax_required .salestax_checkbox").click(function(){
		...
		else
		{
			...
			//var show_price = 1;
			//var show_price = 0;
			$('.multi_item_salestax_checkbox').removeClass("check-on");
			$('.multi_item_salestax_checkbox').addClass("check-off");
			$('.multi_item_tax_hide_show').hide();
			$(".multi_item_salestax_hidden_cb").val("0");
		}
...
$(".multi_item_salestax_required .multi_item_salestax_checkbox").click(function(){
		if($(this).hasClass("check-on")){
			$(this).removeClass("check-on");
			$(this).addClass("check-off");
			$(this).parents(".form-light-holder").children(".multi_item_salestax_hidden_cb").val("0");
			//$('#up_price').attr('required', false);
			$('.multi_item_tax_hide_show').hide();
			//var show_price = 0;
		...
		else
		{
			$(this).removeClass("check-off");
			$(this).addClass("check-on");
			$(this).parents(".form-light-holder").children(".multi_item_salestax_hidden_cb").val("1");
			$('.multi_item_tax_hide_show').show();
			$('.salestax_checkbox').removeClass("check-on");
			$('.salestax_checkbox').addClass("check-off");
			$('.tax_hide_show').hide();
			$(".salestax_hidden_cb").val("0");
		}
...
<input type="hidden" class="totalAddMoreItems" value="<?php echo !empty($items) ? count($items) : 1; ?>"  />
...
<script language="javascript" type="text/javascript">
	...
	function validateDecimal(value) {
		...
		// kz 22-04-2019
			...
			var totalAddMoreItems = $('.totalAddMoreItems').val();
			var b = parseInt(totalAddMoreItems) + Number(1);
			var ckeditor_id = 'dojocart_item_desc_'+b;
			var multi_item_salestax = $('.multi_item_salestax_hidden_cb').val();
			var salestax_display = 'none';
			if(multi_item_salestax == 1){
				var salestax_display = 'inline-block';
			}
			
			$('.totalAddMoreItems').val(b);
				$('#item_option').append('<div class="multi_item_boxes"><div class="form-light-holder"><h1><b>Item #'+b+'</b></h1><h1> Item #'+b+' Title</h1><input type="text" value="" name="dojocartItem['+b+'][item_title]" id="item_title" class="field full_width_input" placeholder=""/></div><div class="form-light-holder manage-pricerow"><h1>Item #'+b+' Price</h1><div class="price-validate"><?php echo $this->query_model->getSiteCurrencyTypeForAdmin() ?><input type="text" required="required" value="" name="dojocartItem['+b+'][item_price]" id="item_price" class="field item_price" number="'+b+'" placeholder="Enter Price" style="width:100px"/><div class="ErrorMessage ErrorMessage_up_price'+b+'"></div></div><div class="price-validate multi_item_tax_hide_show" style="display:'+salestax_display+'"><span style="padding-left: 15px;">Sales Tax (%)</span><input type="text" value=""  name="dojocartItem['+b+'][sales_tax]" id="sales_tax" class="field sales_tax_main" number="'+b+'" placeholder="%" style="width:100px; margin-left: 10px;" /><div class="ErrorMessage ErrorMessage_sales_tax_main'+b+'"></div></div></div><div class="form-new-holder"><h1>Item #'+b+' DESCRIPTION</h1><textarea type="text" value="" name="dojocartItem['+b+'][item_description]" id="'+ckeditor_id+'" class="field" placeholder="" /></textarea></div></div>');
