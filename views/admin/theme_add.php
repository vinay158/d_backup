...
<div class="mb-3 main-content-label page_main_heading">Add: Theme</div>
<div class="form-light-holder">
	<h1>Theme Name</h1>
	<input type="text" value="" name="theme_name" id="name" class="field" placeholder="Enter your theme name here" />
</div>
