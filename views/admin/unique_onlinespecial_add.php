...
<h1>Override Logo</h1>
 ...
 <div class="form-light-holder" style="display:none">
        <h1>Page Title</h1>
        <input type="text" name="title"  id="title" class="field full_width_input" placeholder="Enter Title here" style="" />
    </div>
...
<div class="row row-xs align-items-center">
	...
	<div class="form-light-holder">
        <h1>Offer Title</h1>
        <input type="text" name="offer_title" id="offer_title" class="field full_width_input"  maxlength="100"   placeholder="Enter Offer Title here"/>
    </div>
    <div class="form-light-holder" style="display:none">
 ...
 <div class="form-light-holder">
		...
		<div id="AddMoreFeatures">
			<div class=""><h3><a href="javascript:void(0);" class="btn btn-outline-light  AddMoreButton">Add More</a></h3></div>
