...
<div class="az-content-body-left advanced_page custom_full_page" >
	<div class="az-content-header d-block d-md-flex">
		<div class="az-dashboard-one-title">
			<div>
			  <h2 class="az-dashboard-title">Add: Promo Code</h2>
			</div>
...
<div class="mb-3 main-content-label page_main_heading">Add: Promo Code</div>
...
<div class="form-light-holder   d-md-flex  dual_input">
	...
	<input type="text" value="" name="title" id="" class="field" placeholder="Enter Promo Code Name here"  required/>
...
<div class="form-light-holder   d-md-flex  dual_input">
	...
	<input type="text" value="" name="discount_amount" id="discount_amount" class="field" placeholder="Value in Amount (<?php echo $this->query_model->getSiteCurrencyTypeForAdmin() ?>)"/>
	...
	<div class="percent_box">
		...
		<input type="text" value="" name="discount_percent" id="discount_percent" class="field" placeholder="Value in Percent (%)"  />
	...
	<div class="linkTarget form-group">
		<h1>Expiry Date</h1>
		<input type="text" value="" name="expiry_date" id="date" class="field" placeholder="mm/dd/yyyy" maxlength="10" required />	
	</div>
...
<div class="row row-xs align-items-center">
	...
	<div class="row mg-t-10">
		<div class="col-lg-3">
		  <label class="rdiobox">
			<input type="radio" class="connect_to_trials" name="connect_to_trials" value="all_trials" checked />
			<span>ALL Trials</span>
		  </label>
		</div><!-- col-3 -->
		<div class="col-lg-9 mg-t-20 mg-lg-t-0">
		  <label class="rdiobox">
			<input type="radio" class="connect_to_trials" name="connect_to_trials" value="some_trials"  />
...
<div class="form-light-holder trial_offers_checkboxes" style="display:none">
	...
	<label class="ckbox">
	<input type="checkbox" class="" name="trial_offers[<?php echo $offer->id; ?>]" value="<?php echo $offer->id; ?>" /> <span><?php echo $offer->offer_title; ?> </span></label>
	</div>
	<?php } ?>
	</div>
	</div>
