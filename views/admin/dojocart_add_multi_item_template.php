...
<input type="text" value="" name="price" id="" class="field" placeholder="Enter Price" style="width:100px; margin-left: 10px;" /><div class="ErrorMessage ErrorMessage_price"></div>
</div>
...
<div class="form-light-holder multi_item_salestax_required">
		<a id="status" class="multi_item_salestax_checkbox check-off"></a>
		<h1 class="inline">Add Sales Tax On Multi Items?</h1>
		<input type="hidden" value="0" name="multi_item_sales_taxable" class="multi_item_salestax_hidden_cb" />
</div>
...
<div class="form-light-holder item_required ">
		<a id="status" class="item_checkbox check-off"></a>
		<h1 class="inline">Add Dojocart Item? </h1>
		<input type="hidden" value="0" name="dojocart_item" class="item_hidden_cb" />
</div>
...
<div class="form-light-holder">
	<h1> <b>Item #1</b></h1>
	<h1> Item #1 Title</h1>
	<input type="text" value="" name="dojocartItem[1][item_title]" id="item_title" class="field full_width_input" placeholder="" style="width:40%"/>	
</div>
...
$(document).ready(function(){
	...
	$('#upsale_option').hide();
	$('#item_option').hide(); // kz 22-04-2019
	$('.tax_hide_show').hide();
...
<input type="hidden" class="totalAddMoreItems" value="1"  /> <!-- kz 22-04-2019 -->
