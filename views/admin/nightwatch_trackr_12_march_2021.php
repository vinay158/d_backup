...
<div class="panel-body ordersListTable rank_traker_response">
			...
			<div class="row keyword_box_data1">
              <div class="col-6 col-sm-3 custom-keyword-box first">
			  ...
			  <div class="col-6 col-sm-3 custom-keyword-box first" >
                ...
                <div class="chart-wrapper">
                  <div class="d-md-flex">
					...
					?>
					<div class="col-md-12  mg-lg-l-0 mg-t-20 mg-md-t-0 search_visibility">
			  ...
			  <div class="col-6 col-sm-3 custom-keyword-box first" >
				...
				<?php } ?>
				 ...
				 <div class="col-6 col-sm-3 custom-keyword-box ">
			...
			<div class="row keyword_box_data1">
			  ...
			  <div class="col-6 col-sm-3 custom-keyword-box first" >
                <div class="chart-wrapper">
					<div class="d-md-flex chart2">
						<canvas id="chart-2-container" class="ht-150"></canvas>
					</div>
					<div class="d-md-flex chart3">
						<canvas id="chart-3-container" class="ht-150"></canvas>
					</div>
					<div class="d-md-flex chart4">
						<canvas id="chart-4-container" class="ht-150"></canvas>
					</div>
                </div><!-- chart-wrapper -->
              </div><!-- col -->
...
graphData.push(<?php echo $series[1] ?>);
<?php 
...
<?php } ?>
 ...
 var ctx1 = document.getElementById('chart-2-container').getContext('2d');
  new Chart(ctx1, {
    type: 'bar',
    data: {
      labels: graphLabel,
...
graphLabel.push('<?php echo $series[0] ?>');
graphData.push(<?php echo number_format($series[1],1) ?>);
<?php 
	if($series[1] > $max_value){
		$max_value = round($series[1],-2);
	}
...
<?php } ?>
 ...
 var ctx1 = document.getElementById('chart-3-container').getContext('2d');
  new Chart(ctx1, {
    type: 'bar',
    data: {
      labels: graphLabel,
...
<?php } ?>
 ...
 var ctx1 = document.getElementById('chart-4-container').getContext('2d');
  new Chart(ctx1, {
    type: 'bar',
    data: {
      labels: graphLabel,
