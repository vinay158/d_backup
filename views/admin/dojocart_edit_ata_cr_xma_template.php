    ...
    <div class="az-content az-content-app az-content-contacts pd-b-0">
      <div class="container">
        ...
        <div class="az-content-body az-content-body-contacts">
				...
				<div class="az-mail-header">
            <div>
              <h4 class="az-content-title mg-b-5">Edit DojoCart:  <?php echo str_replace('_',' ',$details[0]->template); ?> Template</h4>
            </div>
...
<div class="form-light-holder" style="" id="">
	...
	<textarea name="form_bottom_text"  id="ckeditor_form_bottom_text" class="ckeditor" ><?php echo $deatail->form_bottom_text; ?></textarea>
</div>

<div class="form-light-holder" style="display:<?php echo ($deatail->template == "novice_blank") ? 'block' : 'none'; ?>" id="">
	<h1>Form Right Sidebar Text</h1>
	<textarea name="form_right_side_text"  id="ckeditor_form_right_side_text_text" class="ckeditor" ><?php echo $deatail->form_right_side_text; ?></textarea>
</div>
...
<a href="javascript:void(0)" class="delete_upsell displayNone" number="<?=$upsell_opt->id?>">Delete This Upsell</a>
...
<div class="form-light-holder manage-pricerow displayNone">
	...
	<div class="price-validate tax_hide_show displayNone">
	<span style="padding-left: 15px;">Sales Tax (%)</span>	
	...
	<div style="font-style:italic;font-size:11px;margin-left:12px;" class="displayNone">
		Please enter the amount in decimal form. Do not use any characters such as "$” or “%". Example: "49.99" or “7”.
	</div>
...
<div class="addMoreCoupons  displayNone"  style=" display:<?php if($deatail->coupon_code == 1) echo "block"; else echo "none"; ?>" id="hide_coupon_code">
			...
			<h1><b>Custom Field #<?= $n ?></b></h1>
				...
				<div class="adsUrl form-group">
					...
					<div class="linkTarget form-group" style="margin-left: 10%;">
						...
						<label class="rdiobox">
						<input type="radio" name="custom_field[<?= $n ?>][is_field_required]" class="small_large_logo" value="1" <?php echo ($custom_field->is_field_required == 1) ? 'checked="checked"' : ''; ?>> <span>Yes </span>
		  </label> 
						<label class="rdiobox">
						<input type="radio" name="custom_field[<?= $n ?>][is_field_required]" class="small_large_logo" value="0" <?php echo ($custom_field->is_field_required == 0) ? 'checked="checked"' : ''; ?>> <span>No</span>
		  </label>
					</div>
				</div>
