...
$("#delete_img_left").click(function(){
		...
		$.ajax({ 					
		type: 'POST',						
		url: 'admin/onlinespecial/deleteHeaderImage',						
		data: { image_path:image_path,photo:photo}					
		}).done(function(msg){ 
		if(eval(msg) == 1){
...
<div class="form-light-holder">
	...
	<h1>Title</h1>
<textarea type="text" name="description" id="header_title" class="field ckeditor full_width_input" placeholder=""  style=""/><?php echo !empty($pagedetails) ? $pagedetails[0]->description : '';?></textarea>
