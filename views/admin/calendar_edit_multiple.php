...
<div id="deploy_holder">
	...
	foreach($multiple_dates as $mdate):?>
		...
		<div style="float:left;">
			<h1>Date</h1>
			<input type="text"  value="<?php echo date('Y/m/d',strtotime($mdate['date']));?>"  name="date1[]" class="form-control multiple_dates" placeholder="mm/dd/yyyy" maxlength="10" style="width: 200px; margin: 0; "/>
...
<span class="closed_days">
		<div style="float:left; margin-left: 20px;">
			<h1>Repeat</h1>
			<select name="repeat1[]" id="repeat1" class="calendar_event_dropdown">
		...
		<?php if($i > 1){ ?>
			<div style="float:right; margin-left: 10px;margin-top:30px" class="removeEvent">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('body').on('focus','.multiple_dates',function(){
