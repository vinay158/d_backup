...
Upload.prototype.doUpload = function (field_name) {
    ...
    $.ajax({
        type: "POST",
        url: "admin/programs/ajaxSaveCategoryFullRowImage",
        xhr: function () {
...
<div class="upload_img_pre_loader" style="display:none"><img src="<?=base_url();?>assets_admin/img/pre_loader.gif"></div>
	...
	<div><img id='fullrow_img' src="<?php echo base_url().'upload/program_category/'.$detail->photo;?>" style="width: 100px; clear:both;" /></div>
	<?php endif;?>
