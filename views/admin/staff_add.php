...
<div class="mb-3 main-content-label">Add: Instructor</div>
...
<div class="form-light-holder">
	...
	<div class="row row-xs align-items-center">
			...
			<div class="row mg-t-10">
				<div class="col-lg-3">
				  <label class="rdiobox">
					<input type="radio" class="lightbox_or_url" name="lightbox_or_url" value="lightbox" checked="checked" />
					<span>Show bio in lightbox</span>
				  </label>
				</div><!-- col-3 -->
				<div class="col-lg-9 mg-t-20 mg-lg-t-0">
				  <label class="rdiobox">
					<input type="radio" class="lightbox_or_url" name="lightbox_or_url" value="url" />
