...
<div class="form-light-holder">
	...
	<input type="text" name="img_top_spacing" id="img_top_spacing" class="field  img_top_spacing" placeholder=""  style="width: 7%" value=""/> <span style="font-size:15px"><strong>px</strong></span><br/>
