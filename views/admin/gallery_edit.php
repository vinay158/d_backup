...
<div class="program_full_detail page-section new_lisiting_block default_template" id="AlternatingFullWidth">
			...
			<ul class="ajax_record_sortable alternating_full_width_row"  table_name="tblmedia" >
...
$(document).ready(function(){
	...
	$('body').on('click','.update_album_info_submit', function(){
		...
		if(error == 0){
			...
			$.ajax({ 					
				type: 'POST',						
				url : 'admin/gallery/ajax_update_album_info',
				dataType : 'json',
	...
	$("body").on('click','#delete_img_left',function(){
			...
			$.ajax({ 					
			type: 'POST',						
			url: 'admin/gallery/deleteVideoCustomImage',						
	...
	<div id="popupEditVideoToAlbum" class="modal">
      <div class="modal-dialog modal-dialog-centered sortable-box" role="document">
        <div class="modal-content modal-content-demo">
		  ...
		  <form action="admin/<?=$link_type?>/operateMedia" method="post"  enctype="multipart/form-data"   id="operateform" onSubmit="javascript:return testUrlForMedia(this);">
          <div class="modal-body edit-form">
            <div class="row row-xs align-items-center">
					<div class="col-md-12 mg-t-5 mg-md-t-0">
						<h1>Album</h1>
