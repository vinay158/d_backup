...
<div class="form-light-holder">
    	<span class="field_title">News Head Title</span><br />
       <input type="text" name="title" required=""  class="field full_width_input" value="<?= !empty($page_title)? $page_title[0]->title:''; ?>" style="" />&nbsp;
       <input type="hidden" name="id" value="2"  />
       <input type="hidden" name="redirect" value="admin/news/view" />
</div>
					...
					<div class="col-md-12 mg-t-5 mg-md-t-0 ">
						<div class="az-content-body ">
							...
							<div class="az-mail-header">
								...
								<div>
								 <a href="admin/<?=$link_type?>/add" class="button_class btn btn-indigo ">Add News</a>
								</div>
							  </div>
							  
			<ul class="ajax_record_sortable alternating_full_width_row"  table_name="tblnews" >
					...
					<li   id="menu_<?=$row->id?>" class="full_width_row_<?=$row->id?> az-contact-info-header">
						<div class="manager-item media">
							<div style="float:left;">
								...
								<img src="<?php echo !empty($row->image) ? $row->image : base_url().'assets_admin/img/no-image.png'?>" class="list_img">									
						...
						<nav class="nav">
							  ...
							  <a href="admin/<?=$link_type;?>/edit/<?=$row->id;?>" class="badge badge-primary">Edit</a>
									...
									<a class="badge badge-primary ajax_record_delete" data-toggle="modal" data-target="#popupDeleteRecord" item_id="<?=$row->id;?>"   table_name="tblnews" item_title="<?=$row->title;?>" section_type="full_width">Delete</a>
									
									<a href="javascript:void(0)" id="unpub_<?=$row->id; ?>" class="ajax_record_publish"  table_name="tblnews"  is_new="0">
...
<?php endif;?>
	...
	<input type="hidden" name="mod_type" value="<?=$link_type;?>" id="mod_type" />		
		...
		<div class="col-md-12 pagination_block nopadding" style="top:50px">		
