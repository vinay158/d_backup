...
<div id="dropdown-holder" style="display: none">
  ...
  <div class="dropdown-panel">
    ...
    <div class="dropdown-title">
      ...
      <div style="float:left;" class="drop-add-title">Duplicate Trial Offer</em></div>
	...
	$(document).ready(function(){
		...
		<div class="dropdown-body" >
		    ...
		    <form action="admin/<?=$link_type?>/duplicate_trial_offer" method="post" id="operateform">

			<div class="form-item">

				<h1>Trial Offer Title</h1>
					<div style="margin-bottom:10px;">

						Note: If you want then change trial offer title 

					</div>

				

				<input type="text" name="offer_title" id="program_title" class="field" value="">
				<input type="hidden" name="id" id="program_id" class="field" value="">
				<input type="hidden" name="cat_id" id="category_id" class="field" value="">
