	...
	$(document).ready(function(){
		...
		<div class="dropdown-body" >
			...
			<div class="form-item">
				...
				<?php echo $this->query_model->getCategoryDropdownOptions('videos',0, 0,0); ?>
				</select>
			</div>
			<?php } ?>
			<div class="form-item">
                ...
                <div class="form-item">
                    ...
                    <textarea rows="8" cols="50" name="description" id="cat_description"></textarea>

                </div>

           <script language="javascript">
$(document).ready(function(){
$(".form-light-holder1 .checkbox").click(function(){
	if($(this).hasClass("check-on")){
		$(this).removeClass("check-on");
		$(this).addClass("check-off");
		$(this).parents(".form-light-holder1").children(".hidden_cb").val("0");
	}
	else
	{
		$(this).removeClass("check-off");
		$(this).addClass("check-on");
		$(this).parents(".form-light-holder1").children(".hidden_cb").val("1");
	}
})
})
</script>
<div class="form-light-holder1">
