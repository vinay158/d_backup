...
<script language="javascript" type="text/javascript">
	...
	var facility_id='<?=$id?>';
	var page ='facility';
	var _uploadLimit =<?=($max_upload_media_limit)?$max_upload_media_limit:0; ?>;
...
<script src="<?=base_url();?>js/facilityupload.js"></script>
...
<div class="dropdown-bottom">
	<div style="padding:10px 20px">
		...
		<!--
		<span class="btn-saveandclose"></span>  
		<input type="button" name="refresh" id='pix_refresh'  style="margin-left:5px;margin-top:5px;float:left;" >
		-->
	</div>	
</div>				
<!-- uploader code end -->
