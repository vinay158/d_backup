  ...
  <div class="dropdown-panel">
	...
	$(document).ready(function(){
		...
		<div class="dropdown-body" >
		    ...
		    <form action="admin/<?=$link_type?>/duplicate_form" method="post" id="operateform">
			...
			<div class="form-item">
				...
				<h1>Title</h1>
					<div style="margin-bottom:10px;">
						...
						Note: If you want then change title 

					</div>

				

				<input type="text" name="name" id="form_title" class="field" value="">
