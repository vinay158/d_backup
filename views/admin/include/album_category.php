					...
					<h1>Categories</h1>
							...
							$(document).ready(function(){
								...
								var action_path = 'admin/albums/videos_cat_delete/'+del_item_id;
								...
								$(".cat-edit").click(function(){
									...
									$.ajax({
										type: "POST",
										dataType: "json",
										url: base_url+"admin/albums/getCategory",
										data: { cat_id: edit_id }
									})		
									.done(function( obj ) {
										...
										$("#publishedCheckbox").val(obj.published);
										if(obj.published == 0){
											$('#published').removeClass('check-on');
											$('#published').addClass('check-off');
										}else{
											$('#published').removeClass('check-off');
											$('#published').addClass('check-on');
										}
										//$("#cat_title").val(obj.cat_name);
							...
							<input type="hidden" id="mod_type" value="albums" />
							<input type="hidden" id="mod_type1" value="albums" />
								</ul>
							</div>
						</div>
