					...
					<div class="col-md-12 mg-t-5 mg-md-t-0 ">
						<div class="az-content-body ">
							...
							<div class="az-mail-header">
								...
								<a href="admin/staff/add/multilocation/<?=$this->uri->segment(4) ?>" class="button_class btn btn-indigo ">	Add Instructor</a>
								<?php } else { ?>
								<a href="admin/staff/add"  class="button_class btn btn-indigo ">Add Instructor</a>
								<?php } ?>
								 
								</div>
							  </div>
							  
			<ul class="ajax_record_sortable alternating_full_width_row"  table_name="tblstaff" >
					...
					<li   id="menu_<?=$row->id?>" class="full_width_row_<?=$row->id?> az-contact-info-header">
						<div class="manager-item media">
							<div style="float:left;">
								...
								<img src="<?php echo !empty($row->photo) ? base_url().'upload/staff/'.$row->photo : base_url().'assets_admin/img/no-image.png'?>" class="list_img">	
						...
						<nav class="nav">
							  ...
							  <a href="admin/staff/edit/<?=$row->id;?>" class="badge badge-primary">Edit</a>
							  
									<a class="badge badge-primary ajax_record_delete" data-toggle="modal" data-target="#popupDeleteRecord" item_id="<?=$row->id;?>"   table_name="tblstaff" item_title="<?=$row->name;?>" section_type="full_width">Delete</a>
									
									<a href="javascript:void(0)" id="unpub_<?=$row->id; ?>" class="ajax_record_publish"  table_name="tblstaff"  is_new="0">
