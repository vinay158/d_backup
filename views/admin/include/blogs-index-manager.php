					...
					<div class="col-md-12 mg-t-5 mg-md-t-0 ">
						<div class="az-content-body ">
							...
							<div class="az-mail-header">
								...
								<div>
								 <a href="admin/<?=$link_type?>/add" class="button_class btn btn-indigo ">Add Blog</a>
								</div>
							  </div>
							  
			<ul class=" alternating_full_width_row"  table_name="tblblogs" >
					...
					<li   id="menu_<?=$row->id?>" class="full_width_row_<?=$row->id?> az-contact-info-header">
						...
						<nav class="nav">
							  ...
							  <a href="admin/<?=$link_type;?>/edit/<?=$row->id;?>" class="badge badge-primary">Edit</a>
									...
									<a class="badge badge-primary ajax_record_delete" data-toggle="modal" data-target="#popupDeleteRecord" item_id="<?=$row->id;?>"   table_name="tblblogs" item_title="<?=$row->title;?>" section_type="full_width">Delete</a>
									
									<a href="javascript:void(0)" id="unpub_<?=$row->id; ?>" class="ajax_record_publish"  table_name="tblblogs"  is_new="0">
