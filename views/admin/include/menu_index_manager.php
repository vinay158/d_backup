...
<div class="program_full_detail page-section new_lisiting_block default_template" id="AlternatingFullWidth">
						...
						<div class="az-content-body ">
							...
							<div class="az-mail-header">
								<div>
								  ...
								  <p>You have <span class="total_alternating_full_width_row"><?php echo !empty($menus) ? count($menus) : 0; ?></span> Entries</p>
								</div>
								<div>
								 <a href="admin/<?php echo $link_type?>/add" class="button_class btn btn-indigo ">Add Menu</a>
								</div>
							  </div>
							  
			<ul class="ajax_record_sortable alternating_full_width_row"  table_name="tblmenus" >
			...
			?>
					...
					<li   id="menu_<?=$row->id?>" class="full_width_row_<?=$row->id?> az-contact-info-header">
						...
						<nav class="nav">
							 <?php echo date_format(date_create($row->timestamp), 'F d, Y H:m A'); ?> &nbsp; &nbsp; &nbsp; &nbsp;
							 <a href="admin/<?php echo $link_type; ?>/manage/<?php echo $row->id; ?>" class="badge badge-primary">Manage</a>
							  <a href="admin/<?php echo $link_type; ?>/edit/<?php echo $row->id; ?>" class="badge badge-primary">Edit</a>
									
									<a href="javascript:void(0)" id="unpub_<?=$row->id; ?>" class="ajax_record_publish"  table_name="tblmenus"  is_new="0">
