...
<div class="form-light-holder   d-md-flex  dual_input">
	...
	<h1>User Name</h1>
	<input type="text" value="" name="username" id="username" class="field" placeholder="Enter user name here"/>
	</div>
	
	<div class="linkTarget form-group">
		<h1>Password</h1>
		<input type="password" name="password" id="password" class="field" placeholder="Enter password here"/>
	</div>
</div>
