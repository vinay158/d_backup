...
<div class="form-light-holder">
	...
	<input type="text" value="<?php if(!empty($pagedetails)){ echo $pagedetails[0]->title; } ?>" name="title" id="" class="field" placeholder="Enter title here"  style="width: 98%" required/>
...
<div class="form-light-holder">
	...
	<textarea type="text" name="description" id="ckeditor_mini" class="field ckeditor" placeholder=""  style="width: 98%"/><?php echo !empty($pagedetails) ? $pagedetails[0]->description : '';?></textarea>
