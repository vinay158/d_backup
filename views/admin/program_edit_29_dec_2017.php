...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		...
		<input value="<?php echo $details->program_cat_image_alt_text; ?>" name="program_cat_image_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
<div class="form-light-holder">
	<span class="field_title">Image Top Spacing</span><br />
	<input type="text" name="program_cat_img_top_spacing" id="program_cat_img_top_spacing" class="field  img_top_spacing" placeholder=""  style="width: 7%" value="<?=$details->program_cat_img_top_spacing?>"/> <span style="font-size:15px"><strong>px</strong></span><br/>
...
<div class="form-light-holder" style="overflow:auto;">
		...
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->header_image_alt_text; ?>" name="header_image_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
<div class="form-light-holder" style="overflow:auto;">
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->body_image_alt_text; ?>" name="body_image_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
<div class="form-light-holder">
	<h1> Color Overlay And Opacity  Picker</h1>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->benefits_image_1_alt_text; ?>" name="benefits_image_1_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->benefits_image_2_alt_text; ?>" name="benefits_image_2_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->benefits_image_3_alt_text; ?>" name="benefits_image_3_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
	...
	<div class="form-light-holder">
		<h1>Video Title</h1>
		<input type="text" name="video_title" value="<?=$details->video_title;?>" class="field" style="width:98%">
	</div>
	<div class="form-light-holder">
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->action_image_1_alt_text; ?>" name="action_image_1_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->action_image_2_alt_text; ?>" name="action_image_2_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->action_image_3_alt_text; ?>" name="action_image_3_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->statistics_image_1_alt_text; ?>" name="statistics_image_1_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->statistics_image_2_alt_text; ?>" name="statistics_image_2_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->statistics_image_3_alt_text; ?>" name="statistics_image_3_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->benefits_2_image_1_alt_text; ?>" name="benefits_2_image_1_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->benefits_2_image_2_alt_text; ?>" name="benefits_2_image_2_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->benefits_2_image_3_alt_text; ?>" name="benefits_2_image_3_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->white_stripe2_image_alt_text; ?>" name="white_stripe2_image_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->benefits_3_image_1_alt_text; ?>" name="benefits_3_image_1_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->benefits_3_image_2_alt_text; ?>" name="benefits_3_image_2_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder" style="overflow:auto;">
	...
	?>	
		<div>
		<h1 style="padding-top: 5px;">Image alt text</h1>
		<input value="<?php echo $details->benefits_3_image_3_alt_text; ?>" name="benefits_3_image_3_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder">
	...
	<input type="text" value="<?php echo $details->testimonials_h2_text; ?>" name="testimonials_h2_text" id="" class="field" placeholder="h2 above the testimonials" />
</div>
...
<div class="form-light-holder">
	...
	?>
		<input type="checkbox" name="testimonial_ids[]" value="<?php echo $testimonial->id; ?>" <?php echo (!empty($selectedTesti) && (in_array($testimonial->id , $selectedTesti))) ? 'checked=checked' : ''; ?>> <?php echo $testimonial->title.' ('.$testimonial->name.')'; ?> <br>
	<?php } ?>
</div>
<?php } ?>
...
<div class="form-light-holder">
	...
	<input type="text" value="<?php echo $details->faqs_h2_text; ?>" name="faqs_h2_text" id="" class="field" placeholder="h2 above the faqs" />
</div>
...
<div class="form-light-holder">
	...
	?>
		<input type="checkbox" name="faq_ids[]" value="<?php echo $program_faq->id; ?>" <?php echo (!empty($selectedTesti) && (in_array($program_faq->id , $selectedTesti))) ? 'checked=checked' : ''; ?>> <?php echo $program_faq->title.' / '.$program_faq->title_2; ?> <br>
	<?php } ?>
</div>
<?php } ?>
