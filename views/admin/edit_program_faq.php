...
<div class="form-light-holder">
	...
	<input type="text" value="<?php if(!empty($pagedetails)){ echo $this->query_model->getStrReplaceAdmin($pagedetails[0]->title_2); } ?>" name="title_2" id="" class="field full_width_input" placeholder="Enter title here"  style="" required/>
...
<div class="form-light-holder">
	...
	<textarea type="text" name="description_2" id="ckeditor_mini_2" class="field ckeditor full_width_input" placeholder=""  style=""/><?php echo !empty($pagedetails) ? $pagedetails[0]->description_2 : '';?></textarea>
