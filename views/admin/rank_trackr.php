...
<div class="az-content-body-left advanced_page custom_full_page rank_traker_api_page" >
	<div class="az-content-header d-block d-md-flex">
		<div class="az-dashboard-one-title">
			<div>
			  <h2 class="az-dashboard-title">Ranktrackr Report</h2>
			</div>
	...
	$(document).ready(function(){
		$('.url_types').change(function(){
			...
			$.ajax({
				...
				url : '<?php echo base_url("admin/rank_trackr/ajaxGetRankTrackrKeywords"); ?>',
					type : 'POST',
					dataType :'json',
...
<div class="col-sm-12 col-xl-12 col-lg-12 nopadding">
				<div class="mb-3 main-content-label" >Ranktrackr  Report  
					<?php if(isset($api_reponse_data['report_link']) && !empty($api_reponse_data['report_link']) ){ ?>
						<span style="float:right"><a href="<?php echo $api_reponse_data['report_link']; ?>" class=" delete_row_btn" target="_blank">View Generate Report</a></span> 
					<?php } ?>
				</div>
   ...
   <div class="col-lg-4">
	 <div class="col-lg-4 float-left">
	  ...
	  <div class="col-lg-8 float-left">
	   <a href="<?php echo base_url().'admin/rank_trackr?sort=google' ?>" class="button_class btn btn-outline-light">Clear</a>
	  </div>
   </div>
