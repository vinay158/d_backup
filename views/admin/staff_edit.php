...
$(document).ready(function(){
	...
	$("#delete_lightbox_photo").click(function(){
		...
		$.ajax({ 					
		type: 'POST',						
		url: 'admin/staff/delete_lightbox_photo',						
...
<div class="mb-3 main-content-label">Edit: Instructor</div>
...
<div class="form-light-holder  d-md-flex  dual_input" style="overflow:auto;">
	...
	<label class="custom-file-label" for="customFile">Choose file</label></div>
		...
		<div><img id='img' src="<?=base_url().'upload/staff/'.$d_row->photo;?>" style="width: 100px; clear:both;" /></div>
	...
	<div class="form-light-holder ">
		<div class="row row-xs align-items-center">
			...
			<div class="row mg-t-10">
				<div class="col-lg-3">
				  <label class="rdiobox">
					<input type="radio" class="lightbox_or_url" name="lightbox_or_url" value="lightbox" <?php if(!empty($d_row) && $d_row->lightbox_or_url == 'lightbox'){ echo 'checked=checked'; }elseif(empty($d_row->lightbox_or_url)){  echo 'checked=checked'; } ?>  />
					<span>Show bio in lightbox</span>
				  </label>
				</div><!-- col-3 -->
				<div class="col-lg-9 mg-t-20 mg-lg-t-0">
				  <label class="rdiobox">
					<input type="radio" class="lightbox_or_url" name="lightbox_or_url" value="url" <?php if(!empty($d_row) && $d_row->lightbox_or_url == 'url'){ echo 'checked=checked'; } elseif(empty($d_row->lightbox_or_url)){  echo 'checked=checked'; }?> />
...
<div class="form-light-holder  d-md-flex  dual_input" style="overflow:auto;">
	...
	<div><img id='lightbox_photo_img' src="<?=base_url().'upload/staff/'.$d_row->lightbox_photo;?>" style="width: 100px; clear:both;" /></div>
