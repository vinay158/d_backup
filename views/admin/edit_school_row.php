...
<div class="az-content-body-left advanced_page custom_full_page" >
	<div class="az-content-header d-block d-md-flex">
		<div class="az-dashboard-one-title">
			<div>
			  <h2 class="az-dashboard-title">Edit: Full Width Row</h2>
			</div>
...
<div class="mb-3 main-content-label page_main_heading">Edit: Full Width Row</div>
...
$("#delete_img").click(function(){
		...
		$.ajax({ 					
		type: 'POST',						
		url: 'admin/school/deleteSchoolRowImage',						
		data: { id : id}					
		}).done(function(msg){ 
		if(eval(msg) == 1){
...
<div class="form-light-holder">
	...
	<input type="text" value="<?php if(!empty($pagedetails)){ echo $this->query_model->getStrReplaceAdmin($pagedetails[0]->button_text); } ?>" name="button_text" id="" class="field" placeholder="Enter Button Text here"/>
	</div>
	...
	<input type="text" value="<?php if(!empty($pagedetails)){ echo $this->query_model->getStrReplaceAdmin($pagedetails[0]->button_url); } ?>" name="button_url" id="" class="field" placeholder="Enter Button URL  here"/>
...
<input type="hidden" value="<?php if(!empty($pagedetails)){ echo $pagedetails[0]->location_id; } ?>" name="location_id" class="location_id" />
