...
<div class="program_full_detail new_lisiting_block default_template" id="AlternatingFullWidth">
						...
						<div class="az-content-body ">
							  ...
							  <div class="az-mail-header">
								<div>
								  ...
								  <p>You have <span class="total_alternating_full_width_row_<?php echo $sparkpost_flow->id; ?>"><?php echo !empty($sparkpost_templates[$sparkpost_flow->id]) ? count($sparkpost_templates[$sparkpost_flow->id]) : 0; ?></span> Entries</p>
								</div>
								<div>
			...
			<?php
				...
				$i = 1;
				foreach($sparkpost_templates[$sparkpost_flow->id] as $row):
