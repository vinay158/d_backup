...
$(document).ready(function(){
	...
	$("#delete_img").click(function(){
		...
		$.ajax({ 					
		type: 'POST',						
		url: 'admin/onlinespecial/delete_text_section_image',						
		data: { id : id}					
		}).done(function(msg){ 
		if(eval(msg) == 1){
...
<div class="az-content-body-left advanced_page custom_full_page" >
	<div class="az-content-header d-block d-md-flex">
		<div class="az-dashboard-one-title">
			<div>
			  <h2 class="az-dashboard-title">Text Sections and Full Width Rows</h2>
			</div>
...
<div class="mb-3 main-content-label page_main_heading">Text Sections</div>

<form action="" method="post"  enctype="multipart/form-data">

<div class="form-light-holder">
	<span class="field_title">Sub Title</span>
	<input type="text" value="<?php if(!empty($pagedetails)){ echo $pagedetails[0]->sub_title; } ?>" name="sub_title"  class="field full_width_input" placeholder="Enter sub title here"  style=""/>
</div>
...
<div class="form-light-holder    d-md-flex  dual_input" style="overflow:auto;">
	...
	<div><img id='img' src="<?php echo base_url().'upload/onlinespecial/'.$pagedetails[0]->photo;?>" style="width: 100px; clear:both;" /></div>
	...
	<input value="<?php echo $pagedetails[0]->photo_alt_text; ?>" name="photo_alt_text" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
...
<div class="form-light-holder">
	...
	<?php foreach($testimonials as $testimonial){ 
			$selectedTesti = !empty($pagedetails[0]->testimonial_ids) ? unserialize($pagedetails[0]->testimonial_ids) : '';
					...
					<div class="col-md-12 mg-t-5 mg-md-t-0 ">
						<div class="az-content-body ">
							...
							<div class="az-mail-header">
								...
								<div>
								 <a href="admin/<?=$link_type?>/add_onlinespecial_row" class="button_class btn btn-indigo ">Add Full Width Row</a>
								</div>
							  </div>
							  
			<ul class="ajax_record_sortable alternating_full_width_row"  table_name="tbl_onlinespecial_rows" >
			...
			?>
					...
					<li   id="menu_<?=$row->id?>" class="full_width_row_<?=$row->id?> az-contact-info-header">
						...
						<nav class="nav">
							  ...
							  <a href="admin/<?=$link_type?>/edit_onlinespecial_row/<?=$row->id;?>" class="badge badge-primary">Edit</a>
							  
									<a class="badge badge-primary ajax_record_delete" data-toggle="modal" data-target="#popupDeleteRecord" item_id="<?=$row->id;?>"   table_name="tbl_onlinespecial_rows" item_title="<?=$row->title;?>" section_type="full_width">Delete</a>
									
									<a href="javascript:void(0)" id="unpub_<?=$row->id; ?>" class="ajax_record_publish"  table_name="tbl_onlinespecial_rows"  is_new="0">
...
<?php //$this->load->view("admin/include/conf_delete_onlinespecial_rows"); ?>
