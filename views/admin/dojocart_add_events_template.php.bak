...
<div class="form-light-holder">
<label class="ckbox">
		<input type="checkbox" name="show_date" value="1" class="show_date_checkbox"><span>Show Event Date?</span></label>
</div>
...
<div class="form-light-holder">
<label class="ckbox">
		<input type="checkbox" name="show_time" value="1" class="show_time_checkbox"><span>Show Event Time?</span></label>
</div>
...
$(".coupon_code_required .coupon_code_checkbox").click(function(){
		if($(this).hasClass("check-on")){
			...
			$('.coupon_required').attr('required',false);
			//var show_price = 0;
