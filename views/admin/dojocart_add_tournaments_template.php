...
<div class="form-light-holder">
		<label class="ckbox"><input type="checkbox" name="show_date" value="1" class="show_date_checkbox"><span>Show Tournament  Date?</span></label>
</div>
<div class="show_date_box">
<div class="form-light-holder">
	<h1>Tournament  Date</h1>
	<input type="text" value="<?php echo date('Y-m-d') ?>" name="date" id="start_date" class="field" placeholder="mm/dd/yyyy" maxlength="10"/>
...
<h1>Custom Text</h1>
<textarea name="date_custom_text" id="frm-text"></textarea>
</div>



<div class="form-light-holder">
		<label class="ckbox"><input type="checkbox" name="show_time" value="1" class="show_time_checkbox"><span>Show Tournament  Time?</span></label>
</div>

<div class="show_time_box">
<div class="form-light-holder">
	<div class="adsUrl">
	<h1>Tournament  Start Time</h1>
	<input type="text" name="start_time" class="start_timepicker" value=""/>
	</div>
	<div class="linkTarget">
	<h1>Tournament  End Time</h1>
	<input type="text" name="end_time" class="end_timepicker"/>
	</div>
</div>
...
<h1>Custom Text</h1>
<textarea name="time_custom_text" id="frm-text"></textarea>
</div>
...
<!--<div class="form-light-holder custom_required">
		<a id="status" class="custom_checkbox check-off" connect_box=""></a>
		<h1 class="inline">Add Option for Multiple Attendees?</h1>
		<input type="hidden" value="0" name="show_date" class="custom_hidden_cb" />
</div> -->
...
<script type="text/javascript" src="<?php echo base_url() ?>/lightbox/date_time_picker/wickedpicker.min.js"></script>
 <script>
$(function() {
   var options1 = { now: "<?php echo date('h') ?>:<?php echo date('i') ?>", //hh:mm 24 hour format only, defaults to current time
  ...
  $(function() {
   var options2 = { now: "<?php echo date('h') ?>:<?php echo date('i') ?>", //hh:mm 24 hour format only, defaults to current time
	twentyFour: false, //Display 24 hour format, defaults to false
	upArrow: 'wickedpicker__controls__control-up', //The up arrow class selector to use, for custom CSS
	downArrow: 'wickedpicker__controls__control-down', //The down arrow class selector to use, for custom CSS
	close: 'wickedpicker__close', //The close class selector to use, for custom CSS
