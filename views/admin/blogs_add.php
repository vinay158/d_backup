...
<div class="az-content-body-left  advanced_page custom_full_page" >
	<div class="az-content-header d-block d-md-flex">
		<div class="az-dashboard-one-title">
			<div>
			  <h2 class="az-dashboard-title">Add: Blog</h2>
			</div>
...
<div class="mb-3 main-content-label page_main_heading">Add: Blog</div>
<div class="form-light-holder">
	<h1>Title</h1>
	<input type="text" value="" name="title" id="title" class="field full_width_input" placeholder="Title of Blog Entry"/>	
...
<div class="form-light-holder">
	<h1>Image Alt</h1>
	<input type="text" value="" name="image_alt" id="image_alt" class="field full_width_input" placeholder="Image Alt tag"/>
</div>
...
<!--<div class="form-light-holder" style="">
<h1>Meta Keyword</h1>
	<textarea name="meta_keyword" id="frm-text"></textarea>
...
<script language="javascript">
$(document).ready(function(){
$(".form-light-holder-1 .checkbox").click(function(){
	if($(this).hasClass("check-on")){
		$(this).removeClass("check-on");
		$(this).addClass("check-off");
		$(this).parents(".form-light-holder-1").children(".hidden_cb_1").val("0");
	}
	else
	{
		$(this).removeClass("check-off");
		$(this).addClass("check-on");
		$(this).parents(".form-light-holder-1").children(".hidden_cb_1").val("1");
	}
})

$(".form-light-holder-2 .checkbox").click(function(){
	if($(this).hasClass("check-on")){
		$(this).removeClass("check-on");
		$(this).addClass("check-off");
		$(this).parents(".form-light-holder-2").children(".hidden_cb_2").val("0");
	}
	else
	{
		$(this).removeClass("check-off");
		$(this).addClass("check-on");
		$(this).parents(".form-light-holder-2").children(".hidden_cb_2").val("1");
	}
})
})
</script>
...
<div class="form-light-holder  form-light-holder-1">
...
<div class="form-light-holder form-light-holder-2">
	<a id="published" class="checkbox check-off"></a>
	<h1 class="inline">Hide from Public Blog?</h1>
	<input type="hidden" value="0" name="hide_from_public_blog" class="hidden_cb_2" />
	<br/>
    <span class="note_for_publish">(Turn this off to make this article unpublished)</span>
</div>
