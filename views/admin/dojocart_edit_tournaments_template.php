...
<div class="form-light-holder">
		<label class="ckbox"><input type="checkbox" name="show_date" value="1" class="show_date_checkbox" <?php echo ($deatail->show_date == 1) ? 'checked=checked' : '' ?>><span>Show Tournament  Date?</span></label>
</div>
...
<div class="form-light-holder">
		<label class="ckbox"><input type="checkbox" name="show_time" value="1" class="show_time_checkbox"<?php echo ($deatail->show_time == 1) ? 'checked=checked' : '' ?>><span>Show Tournament  Time?</span></label>
</div>
<div class="show_time_box">
<div class="form-light-holder">
	<div class="adsUrl">
	<h1>Event Tournament  Time</h1>
...
<div class="form-light-holder d-md-flex   dual_input" style="overflow:auto;">
	<div class="adsUrl form-group">
	<h1 style="padding-bottom: 5px;">Upload Tournament  Image </h1>
...
<div class="form-light-holder">
	<h1>Do you want to accept credit card payments for this tournament?</h1>
	<select name="payment_type" class="field payment_type">
	<option value="free"<?php if($deatail->payment_type == "free"){ echo "selected";} ?>>Free Tournament </option>
	<option value="paid"<?php if($deatail->payment_type == "paid"){ echo "selected";} ?>>Paid Tournament </option>
	</select>	
</div>
...
<div class="form-light-holder salestax_required">
		...
		<h1 class="inline">Tournament  Price (<?php echo $this->query_model->getSiteCurrencyTypeForAdmin() ?>)</h1>
