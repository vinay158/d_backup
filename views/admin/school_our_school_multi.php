...
<div class="az-content-body-left advanced_page custom_full_page" >
	<div class="az-content-header d-block d-md-flex">
		<div class="az-dashboard-one-title">
			<div>
			  <h2 class="az-dashboard-title">Instructor / Rows</h2>
			</div>
...
<div class="mb-3 main-content-label page_main_heading">Instructor</div>
...
<div class="form-light-holder   d-md-flex  dual_input" style="overflow:auto;">
	...
	<div><img id='img' src="<?php echo base_url().'upload/school_about_us/'.$pagedetails[0]->photo;?>" style="width: 100px; clear:both;" /></div>
	<input type="hidden" id="last-photo" name="last-photo" value="<?=$pagedetails[0]->photo;?>" />
	<?php endif;?>
	<?php if(!empty($pagedetails[0]->photo)){ 
	...
	<input value="<?php echo !empty($pagedetails) ? $this->query_model->getStrReplaceAdmin($pagedetails[0]->image_alt) : ''; ?>" name="image_alt" id="" class="field" placeholder="image alt text" type="text">
		</div>
</div>
<div class="form-light-holder">
						...
						<div class="az-content-body ">
							...
							<div class="az-mail-header">
								<div>
								  ...
								  <p>You have <span class="total_alternating_full_width_row"><?php echo !empty($schoolRows) ? count($schoolRows) : 0; ?></span> Entries</p>
								</div>
								<div>
								 <a href="admin/school/add_school_row/<?php echo $location_id; ?>" class="button_class btn btn-indigo ">Add Full Width Row</a>
								</div>
							  </div>
							  
			<ul class="ajax_record_sortable alternating_full_width_row"  table_name="tbl_school_rows" >
			...
			?>
					...
					<li   id="menu_<?=$row->id?>" class="full_width_row_<?=$row->id?> az-contact-info-header">
						...
						<nav class="nav">
							  ...
							  <a href="admin/<?=$link_type?>/edit_school_row/<?=$row->id;?>" class="badge badge-primary">Edit</a>
							  
									<a class="badge badge-primary ajax_record_delete" data-toggle="modal" data-target="#popupDeleteRecord" item_id="<?=$row->id;?>"   table_name="tbl_school_rows" item_title="<?=$row->title;?>" section_type="full_width">Delete</a>
									
									<a href="javascript:void(0)" id="unpub_<?=$row->id; ?>" class="ajax_record_publish"  table_name="tbl_school_rows"  is_new="0">
