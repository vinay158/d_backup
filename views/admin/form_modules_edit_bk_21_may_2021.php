...
<div class="form-light-holder   row row-xs align-items-center form-module  page-instance">
	...
	<?php if(!empty($page_instances)){ ?>
		...
		<?php 
			...
			<div class="col-md-4 form_instance  <?php echo (count($form_instances) >= 10) ? 'morethan10' : ''; ?>  <?php echo ($i >= 10) ? 'bigval' : 'smallval'; ?>"><span><?php echo $i; ?></span> <?php echo $page_instance->page_name; ?></div>
		<?php $i++; } ?>
	<?php } ?>
</div>
<?php } ?>
...
<script>
	...
	$(document).ready(function(){
		$(".connected_type").click(function(){
			...
			if(connected_type == "Active Campaign" || connected_type == "MailChimp"){
