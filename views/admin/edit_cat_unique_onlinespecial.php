...
$("#delete_img").click(function(){
		...
		$.ajax({ 					
		type: 'POST',						
		url: 'admin/unique_onlinespecial/deleteCategoryImage',						
...
<div class="form-light-holder">
		...
		<option value="all" <?php echo (!empty($pagedetails) && $pagedetails[0]->location_id == 'all') ? 'selected=selected' : ''; ?>>All Location</option>
		<?php 
			if(!empty($locations)){ 
...
<div class="adsUrl   form-group">
		...
		?>
		<option value="<?php echo $program_cat->cat_id ?>" <?php echo (!empty($pagedetails) && $pagedetails[0]->program_cat_id == $program_cat->cat_id) ? 'selected=selected' : ''; ?>><?php echo $program_cat->cat_name; ?></option>
...
<div class="form-light-holder   d-md-flex  dual_input" style="overflow:auto;">
	...
	<div><img id='img_left' src="<?=base_url().'upload/onlinespecial/'.$pagedetails[0]->left_photo;?>" style="width: 150px; clear:both;" /></div>
...
<script>
$(window).load(function(){
	var program_cat_id = $('#program_cat_id').val();
			
		if(program_cat_id != ""){
			var selected_program_id = '<?php echo !empty($pagedetails) ? $pagedetails[0]->unique_program_id : ''; ?>';
			$('#programs_lists').html('');
			
			$.ajax({ 					
			type: 'POST',						
			url: 'admin/unique_onlinespecial/ajaxGetProgramsListByCat',						
			data: { program_cat_id : program_cat_id, selected_program_id: selected_program_id}					
