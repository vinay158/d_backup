...
<div class="form-light-holder">
	<h1>Title</h1>
	<input type="text" value="<?php echo !empty($detail) ? $this->query_model->getStrReplaceAdmin($detail[0]->title) : '' ; ?>" name="title" id="title" class="field full_width_input" placeholder="Enter Your Page Title Here" style=""/>	
...
<h1>Page Layout</h1>
	<select name="page_layout" class="field">
		<option value="default" <?php echo ($detail[0]->page_layout == "default") ? "selected=selected" : ''; ?>>Default - No Sidebar</option>
	</select>
</div>
...
<div class="form-light-holder">
	<h1>Body Class</h1>
	<input type="text" name="body_class" class="field full_width_input" value="<?php echo !empty($detail) ? $detail[0]->body_class  : '' ; ?>">
</div>
