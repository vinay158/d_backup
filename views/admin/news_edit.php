...
<div class="az-content-body-left advanced_page custom_full_page" >
	<div class="az-content-header d-block d-md-flex">
		<div class="az-dashboard-one-title">
			<div>
			  <h2 class="az-dashboard-title">Edit: News Post</h2>
			</div>
...
$(document).ready(function(){
	...
	$("#delete_img").click(function(){
		...
		if(eval(msg) == 1){
			setTimeout("window.location.href='admin/news/edit/"+news_id+"'",1000);
		}
		else{
...
<div class="mb-3 main-content-label page_main_heading">Edit: News Post</div>
<?php if(!empty($details)): ?>
<?php foreach($details as $details) :?>
<div class="form-light-holder">
	<h1>Title</h1>
	<input type="text" value="<?=$details->title?>" name="title" id="title" class="field full_width_input" placeholder="Enter your name here" style=""/>
...
<!--<div class="form-light-holder">
	<h1>URL Link</h1>
	<input type="text" value="<?=$details->slug?>" name="slug" id="slug" class="field"/>
</div>-->
...
<!--<div class="form-light-holder">
	<h1>Image Alt</h1>
	<input type="text" value="<?=$details->image_alt?>" name="image_alt" id="image_alt" class="field" placeholder="Image Alt tag"/>
</div>
