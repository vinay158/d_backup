...
<script>
	$(document).ready(function(){
		...
		CKEDITOR.replace(  'ckeditor_full',
				...
				CKEDITOR.replace(  'ckeditor_form_bottom_text',
									{  customConfig : 'config.js' }
						);
						
				CKEDITOR.replace(  'form_right_side_text',
									{  customConfig : 'config.js' }
						);
    ...
    <div class="az-content az-content-app az-content-contacts pd-b-0">
      <div class="container">
        ...
        <div class="az-content-body az-content-body-contacts">
				...
				<div class="az-mail-header">
            <div>
              <h4 class="az-content-title mg-b-5">Add DojoCart:  <?php echo str_replace('_',' ',$this->session->userdata('dojo_cart_template')); ?> Template</h4>
            </div>
...
<div class="form-light-holder" style="" id="">
	<h1>Form Bottom Text</h1>
	<textarea name="form_bottom_text"  id="ckeditor_form_bottom_text" class="ckeditor" ></textarea>
</div>

<div class="form-light-holder" style="display:<?php echo ($this->session->userdata('dojo_cart_template') == "novice_blank") ? 'block' : 'none'; ?>" id="">
	<h1>Form Right Sidebar Text</h1>
	<textarea name="form_right_side_text"  id="ckeditor_form_right_side_text_text" class="ckeditor" ></textarea>
</div>

<div class="form-light-holder money_back_img_required displayNone">
...
<div class="form-light-holder satisfaction_gurantee_img_required displayNone">
...
<div class="form-light-holder d-md-flex  dual_input   welcome_video displayNone">
...
<div class="form-light-holder displayNone">
...
<div id="hide_show_p_quant displayNone">

<div class="form-light-holder salestax_required displayNone">
...
<div class="form-light-holder manage-pricerow displayNone" >
...
<div class="form-light-holder showquantity_required displayNone" style="" >
...
<div class="form-light-holder upsale_required displayNone">
...
<div id="upsale_option displayNone">
<div class=""><h3><a href="javascript:void(0);" class="AddMoreUpsale displayNone">Add Another Upsell</a></h3></div>
<div class="form-light-holder displayNone">
...
<div class="form-light-holder coupon_code_required displayNone">
...
<div class="addMoreCoupons displayNone"  style=" display:none" id="hide_coupon_code">
...
<?php 
	$custom_fields = array(
						array('label_text'=>'NAME','type'=>'text','dropdown_values'=>'','required'=>'1','field_coloumn_class' =>'col-md-12'),
						array('label_text'=>'ATA #','type'=>'integer','dropdown_values'=>'','required'=>'1','field_coloumn_class' =>'col-md-12'),
						array('label_text'=>'DATE OF BIRTH','type'=>'text_varchar','dropdown_values'=>'','required'=>'1','field_coloumn_class' =>'col-md-7'),
						array('label_text'=>'COMPETITION AGE','type'=>'integer','dropdown_values'=>'','required'=>'1','field_coloumn_class' =>'col-md-5'),
						array('label_text'=>'COMPETITION RANK','type'=>'dropdown','dropdown_values'=>array('White','Orange','Yellow','Camo','Green','Purple','Blue','Brown','Red','1Blk-R','1Blk-D','2Blk-R','2Blk-D','2Blk-D','3Blk-D','4Blk-D','5Blk-D'),'required'=>'1','field_coloumn_class' =>'col-md-7'),
						array('label_text'=>'GENDER','type'=>'radio','dropdown_values'=> array('M','F'),'required'=>'1','field_coloumn_class' =>'col-md-5'),
						array('label_text'=>'SCHOOL OWNER','type'=>'text','dropdown_values'=> '','required'=>'0','field_coloumn_class' =>'col-md-7'),
						array('label_text'=>'SCHOOL#','type'=>'text','dropdown_values'=> '','required'=>'1','field_coloumn_class' =>'col-md-5'),
						array('label_text'=>'SCHOOL CITY','type'=>'text','dropdown_values'=> '','required'=>'1','field_coloumn_class' =>'col-md-6'),
						array('label_text'=>'STATE','type'=>'text','dropdown_values'=> '','required'=>'1','field_coloumn_class' =>'col-md-6'),
						array('label_text'=>'ZIP','type'=>'integer','dropdown_values'=> '','required'=>'1','field_coloumn_class' =>'col-md-6'),
						
array('label_text'=>'EMAIL','type'=>'email','dropdown_values'=>'','required'=>'1','field_coloumn_class' =>'col-md-6'),
					);
					
		if($this->session->userdata('dojo_cart_template') == "ata_cr_xma"){
			$custom_fields[] = array('label_text'=>'COMPETITIVE DIVISION EVENTS','type'=>'checkbox','dropdown_values'=> array('ATA XTREME 
	FORMS','ATA XTREME WEAPONS','CREATIVE FORMS','CREATIVE WEAPONS'),'required'=>'1','field_coloumn_class' =>'col-md-12');
		}elseif($this->session->userdata('dojo_cart_template') == "tiger_blank"){
			$custom_fields[] = array('label_text'=>'ATA TIGER DIVISION EVENTS','type'=>'checkbox','dropdown_values'=> array('TRADITIONAL FORMS','ONE STEP SPARRING','TRADITIONAL SPARRING','TRADITIONAL WEAPONS','COMBAT BME SPARRING'),'required'=>'1','field_coloumn_class' =>'col-md-12');
			$custom_fields[] = array('label_text'=>'ATA XTREME EVENTS','type'=>'checkbox','dropdown_values'=> array('FORMS','WEAPONS'),'required'=>'1','field_coloumn_class' =>'col-md-6');
			$custom_fields[] = array('label_text'=>'CREATIVE EVENTS','type'=>'checkbox','dropdown_values'=> array('FORMS','WEAPONS'),'required'=>'1','field_coloumn_class' =>'col-md-6');
			$custom_fields[] = array('label_text'=>'FORM','type'=>'text_varchar','dropdown_values'=> array(),'required'=>'1','field_coloumn_class' =>'','right_sidebar' => 1);
			$custom_fields[] = array('label_text'=>'ONE STEP','type'=>'text_varchar','dropdown_values'=> array(),'required'=>'1','field_coloumn_class' =>'','right_sidebar' => 1);
		}elseif($this->session->userdata('dojo_cart_template') == "novice_blank"){
			$custom_fields[] = array('label_text'=>'NOVICE DIVISION EVENTS','type'=>'checkbox','dropdown_values'=> array('TRADITIONAL FORMS','ONE STEP SPARRING','TRADITIONAL SPARRING','TRADITIONAL WEAPONS','COMBAT BME SPARRING'),'required'=>'1','field_coloumn_class' =>'col-md-12');
			$custom_fields[] = array('label_text'=>'ATA XTREME EVENTS','type'=>'checkbox','dropdown_values'=> array('FORMS','WEAPONS'),'required'=>'1','field_coloumn_class' =>'col-md-6');
			$custom_fields[] = array('label_text'=>'CREATIVE EVENTS','type'=>'checkbox','dropdown_values'=> array('FORMS','WEAPONS'),'required'=>'1','field_coloumn_class' =>'col-md-6');
			
		}elseif($this->session->userdata('dojo_cart_template') == "traditional_blank"){
			$custom_fields[] = array('label_text'=>'COMPETITIVE DIVISION EVENTS','type'=>'checkbox','dropdown_values'=> array('TRADITIONAL FORMS','ONE STEP SPARRING','TRADITIONAL SPARRING','TRADITIONAL WEAPONS','COMBAT BME SPARRING'),'required'=>'1','field_coloumn_class' =>'');
			$custom_fields[] = array('label_text'=>'SPECIAL ABILITIES DIVISIONS ONLY','type'=>'checkbox','dropdown_values'=> array('COGNITIVE DIVISION','PHYSICAL DIVISION','AUTISM DIVISION'),'required'=>'1','field_coloumn_class' =>'','right_sidebar' => 1);
		}			
		
					
		//echo '<pre>custom_fields'; print_r($custom_fields); die;
?>
...
<?php if(!empty($custom_fields)){
	...
	?>
		<div class="custom_field_box multi_item_boxes custom_box_<?php echo $key; ?>">
			<h1><b>Custom Field #<?= $n ?></b></h1>
				...
				<i class="fa fa-close" style="cursor:pointer; right:15px; top:10px;color:red; float:right" onclick="$(this).parent().remove();"> Delete</i>
				
				<input type="hidden" name="custom_field[<?= $n ?>][custom_field_id]" value="<?php echo $key; ?>">
				<div class="form-new-holder   d-md-flex   dual_input">
				...
				<div class="adsUrl form-group">
					...
					<select name="custom_field[<?= $n ?>][type]" class="field field_type" number="<?= $n ?>">
						...
						<option value="text_varchar" <?php echo ($custom_field['type'] =="text_varchar") ? 'selected=selected' : '';  ?>>Text - Varchar</option>
						<option value="email" <?php echo ($custom_field['type'] =="email") ? 'selected=selected' : '';  ?>>Email</option>
						<option value="integer" <?php echo ($custom_field['type'] =="integer") ? 'selected=selected' : '';  ?>>Integer</option>
						...
						<option value="radio" <?php echo ($custom_field['type'] =="radio") ? 'selected=selected' : '';  ?>>Radio</option>
					</select>
					</div>
					<div class="linkTarget form-group" style="margin-left: 10%;">
					
						<h1>Field Required?</h1>
						
						<label class="rdiobox">
						<input type="radio" name="custom_field[<?= $n ?>][is_field_required]" class="small_large_logo" value="1" <?php echo ($custom_field['required'] == 1) ? 'checked="checked"' : ''; ?>><span> Yes </span>
		  </label> 
						<label class="rdiobox">
						<input type="radio" name="custom_field[<?= $n ?>][is_field_required]" class="small_large_logo" value="0" <?php echo ($custom_field['required'] == 0) ? 'checked="checked"' : ''; ?>><span> No</span>
		  </label>
					</div>
				</div>
				...
				<div class="form-new-holder">
					<h1>Field Coloumn Class</h1>
						<input value="<?php echo $this->query_model->getStrReplaceAdmin($custom_field['field_coloumn_class']); ?>" name="custom_field[<?=$n?>][field_coloumn_class]" class="field" placeholder="" type="text">
				</div>
				<input type="hidden" name="custom_field[<?=$n?>][right_sidebar]" value="<?php echo (isset($custom_field['right_sidebar'])) ? $custom_field['right_sidebar'] : 0; ?>">
				
				<div class="drodownbox_<?=$n?>" number="<?=$n?>" style="display:<?php echo ($custom_field['type'] =="dropdown" || $custom_field['type'] =="checkbox" || $custom_field['type'] =="radio" ) ? 'block' : 'none'; ?>"><div class="form-new-holder">
				
				
					<a href="javascript:void(0);" class="btn btn-outline-light AddMoreDropdownValues"  number="<?=$n?>">Add  Values</a>
					<?php 
					
					$selectedDropdownValues = !empty($custom_field['dropdown_values']) ? $custom_field['dropdown_values'] : '';
					
						if(!empty($selectedDropdownValues) && ($custom_field['type'] =="dropdown" || $custom_field['type'] =="checkbox" || $custom_field['type'] =="radio")){ 
						$p = 1;
				...
				<input type="hidden" class="totalAddMoreDropdownValues_<?=$n?>" value="<?php echo (!empty($selectedDropdownValues)) ? count($selectedDropdownValues) : 0; ?>"  />
			</div>
...
?>
<div class="form-light-holder locationsDropdown  displayNone">
	<div class="adsUrl">
		<h1>Locations</h1>
...
<?php } ?>
 <div class="form-light-holder">
	...
	<div class="tx-center pd-y-20 bg-gray-200" id="bottom"> 
				<input type="hidden" name="is_unique_dojocart" value="1">
...
$('.AddMoreCouponsButton').click(function(){
		...
		$('.AddMoreCustomFields').click(function(){
			...
			if(custom_field_box >= 20){
				alert('You Have Already Added 20 Custom Fileds'); return false;
			}
			...
			$('.totalAddMoreCustomFields').val(k);
				...
				$('#addMoreFields').append('<div class="custom_field_box multi_item_boxes"><h1><b>Custom Field #'+k+'</b></h1><i class="fa fa-close" style="cursor:pointer; right:15px; top:10px;color:red; float:right" onclick="$(this).parent().remove();"> Delete</i><div class="form-new-holder d-md-flex   dual_input"><div class="adsUrl form-group"><h1>Field Type</h1><select name="custom_field['+k+'][type]" class="field field_type" number="'+k+'"><option value="text">Text</option><option value="text_varchar">Text - Varchar</option><option value="email">Email</option><option value="integer">Integer</option><option value="dropdown">Dropdown</option><option value="checkbox">Checkbox</option><option value="radio">Radio</option></select></div><div class="linkTarget form-group" style="margin-left: 10%;"><h1>Field Required?</h1><label class="rdiobox"><input type="radio" name="custom_field['+k+'][is_field_required]" class="small_large_logo" value="1"> <span>Yes </span></label><label class="rdiobox"><input type="radio" name="custom_field['+k+'][is_field_required]" class="small_large_logo" value="0"  checked="checked"><span> No</span></label> </div></div><div class="form-new-holder"><h1>Label Text</h1><input value="" name="custom_field['+k+'][label_text]" class="field" placeholder="" type="text"></div><div class="form-new-holder"><h1>Field Coloumn Class</h1><input value="" name="custom_field['+k+'][field_coloumn_class]" class="field" placeholder="" type="text"></div><div class="drodownbox_'+k+'" number="'+k+'" style="display:none"><div class="form-new-holder"><a href="javascript:void(0);" class="btn btn-outline-light  AddMoreDropdownValues"  number="'+k+'">Add Values</a><h1>Value #1</h1><input value="" name="custom_field['+k+'][dropdown_values][1]" class="field" placeholder="" type="text"></div><div class="add_moreDropdownValues'+k+'"></div><input type="hidden" class="totalAddMoreDropdownValues_'+k+'" value="1"  /></div></div>');
