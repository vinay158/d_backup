...
$(document).ready(function(){
	...
	$('body').on('click','.update_lead_status_id',function(){
		...
		$.ajax({
				...
				type: "post",
				dataType: "json",
				data: {lead_type:lead_type,lead_id:lead_id,status_type:status_type,'action':'update_lead_status'},
				success:function(data){
					...
					if(data.response == 1){
						...
						$('#popup').modal('hide');
						$('#responsePopup').find('.action_response_msg').html('Successfully tranferd your lead to '+status_type);
