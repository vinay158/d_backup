...
<div class="az-content-body-left advanced_page custom_full_page " >
	<div class="az-content-header d-block d-md-flex">
		<div class="az-dashboard-one-title">
			<div>
			  <h2 class="az-dashboard-title">Add: Advertisement</h2>
			</div>
...
<div class="mb-3 main-content-label page_main_heading">Add: Advertisement</div>
<div class="form-light-holder">
<h1>Advertisement Name</h1>
	<input type="text" name="title" value="" class="full_width_input" id="title" placeholder="Enter Advertisement Title here"  maxlength="25" required="required" />
        	<p><i>Character Limit 25 characters </i></p>
</div>
<div class="form-light-holder">
<h1>Advertisement description</h1>
<input type="text" name="summary" value="" id="" placeholder="Enter Advertisement description here"   style="width: 100%"  maxlength="25"  />
<p><i>Character Limit 25 characters </i></p>
	<!-- <textarea name="summary" id="ckeditor_mini" class="ckeditor" placeholder="Enter Advertisement Summary here"  style="width: 98%" maxlength="270" required="required" /></textarea>
        	 -->
...
<div class="form-light-holder">
	...
	<input type="text" name="url"  id="url" placeholder="Enter Advertisement url here" />
...
<div class="form-light-holder   d-md-flex  dual_input  welcome_video">
	...
	<h1>Youtube Video</h1>
	<input type="text" name="youtube_video" class="field" >
	...
	<h1>Vimeo Video</h1>
	<input type="text" name="vimeo_video"  class="field" >
	<div style="font-style:italic;font-size:11px;margin-left:12px;">
