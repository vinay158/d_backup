...
<div class="form-light-holder">
	<h1>Name</h1>
	<input type="text" value="<?=$d_row->name; ?>" name="name" id="name" class="field" placeholder="Enter your name here"/>
...
<div class="form-light-holder">
	...
	<option value="youtube_video" <?php if($d_row->video_type == 'youtube_video'){ echo 'selected=selected'; } ?>>Youtube Video</option>
	<option value="vimeo_video" <?php if($d_row->video_type == 'vimeo_video'){ echo 'selected=selected'; } ?>  >Vimeo Video</option>
</select>
</div>
<div class="form-light-holder  d-md-flex  dual_input  welcome_video">
	<div class="youtube_video form-group">
	<h1>Youtube Video</h1>
	<input type="text" name="youtube_video" value="<?=$d_row->youtube_video;?>" class="field" >
	...
	<h1>Vimeo Video</h1>
	<input type="text" name="vimeo_video" value="<?=$d_row->vimeo_video;?>" class="field" >
	<div style="font-style:italic;font-size:11px;margin-left:12px;">
