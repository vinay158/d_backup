...
<script>
	...
	$(document).ready(function(){
		$('input#amount').blur(function(){			
				...
				{
				  alert('Oops! You have entered invalid characters in the trial amount field. Please enter the amount in decimal form. Do not use any characters such as "$". Example: "49.99"');
				  $(this).val('');				  
				  return false;
				}				    
		    });		 	
...
<div class="az-content-body-left advanced_page custom_full_page" >
	<div class="az-content-header d-block d-md-flex">
		<div class="az-dashboard-one-title">
			<div>
			  <h2 class="az-dashboard-title">Edit: Trial Offer</h2>
			</div>
...
<div class="mb-3 main-content-label page_main_heading">Edit: Trial Offer</div>
...
<div class="form-light-holder">
	...
	<h1><strong>Trial Info</strong></h1>
        <h1>Offer Title</h1>
        <input type="text" value="<?php echo $this->query_model->getStrReplaceAdmin($special->offer_title)?>" name="offer_title" id="offer_title" class="field full_width_input" maxlength="100" style=""  placeholder="Enter Offer Title here"/>
    </div>
    <div class="form-light-holder" style="display:none">
...
&nbsp;
<div class="form-light-holder">
<a href="javascript:void(0)" class="delete_upsell delete_image_btn_new" number="<?=$upsell_opt->id?>" style="float:right;line-height: 12px;margin-top: -10px;">Delete Upsell</a>
...
<div class="form-light-holder">
	...
	<br/>
	<em>Example: Add a Uniform for only <?php echo $this->query_model->getSiteCurrencyTypeForAdmin() ?>19.99! (reg. <?php echo $this->query_model->getSiteCurrencyTypeForAdmin() ?>49))</em>
</div>	
...
<div class="form-light-holder" style="display:none">
	...
	<input type="text" value="<?php echo $this->query_model->getStrReplaceAdmin($upsell_opt->yes);?>" name="data[<?= $a ?>][yes]" id="yes" class="field full_width_input" placeholder="" style="width:40%"/>	
</div>
<div class="form-light-holder">
...
$(document).ready(function(){
	...
	$(".delete_upsell").click(function(){
		...
		$.ajax({ 					
		type: 'POST',						
		url: 'admin/onlinespecial/delete_upsell',						
		data: { upsell_id : upsell_id}					
		}).done(function(msg){ 
		if(eval(msg) == 1){		
			//$('.stand_page_'+upsell_id).hide();
			setTimeout("window.location.href='admin/onlinespecial/edit/"+trial_offer_id+"'",1000);			
		}
		else{
