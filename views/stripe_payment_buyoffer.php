...
<script>
  ...
  <form class="" id="payment-form" method="post" action="<?php echo $domain_host; ?>payment/stripe_payment_gateway">
...
?>
 ...
 <span class="payment-errors"></span>
          ...
          <div class="col-md-6 col-sm-6">
			...
			<input type="text" class="form-control cc_number" name="credit_card_number" id="credit_card_number" data-stripe="number">
...
<?php //echo '<pre>';print_r($offer_detail_service); die; ?>
           ...
           <!--  <input type="submit" name="submit" class="btn btn-theme" value="Submit Order"> </button> -->
            <input type="submit" name="submit" class="btn btn-theme submitPaymentButton submit" value="Submit Order"> </button>
...
<script type="text/javascript">
	/*Stripe.setPublishableKey('pk_test_RDm9fKSZOjt1n6ZJnAePyL7t');
  
	$(function() {
	  var $form = $('#payment-form');
	 
	  $form.submit(function(event) {
		  // alert($form.find('#exp_year').val()); return false;
		// Disable the submit button to prevent repeated clicks:
		$form.find('.submit').prop('disabled', true);
		
		// Request a token from Stripe:
		var tokenNumber = Stripe.card.createToken($form, stripeResponseHandler);
