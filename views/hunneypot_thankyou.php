...
<h3>Thank you for your interest in <?php echo $site_settings[0]->title; ?>. A representative will contact you within 24 hours!</h3>
...
<p>&nbsp;</p>      </div>
 ...
 <div style="font-size: 12px;text-align: center;"> <?php echo $hunneypot_error_msg;  ?></div>
