      ...
      <nav id="navigation" class="navbar navbar-inverse  main-nav  <?php if($pageurl == 'programs' || $pageurl == 'ourprograms'){ echo ' hidden-md hidden-lg'; }?>" >
         <div class="container-fluid">
            ...
            <div class="navbar-header">
			   ...
			   <a href="#" class="phone-icon mobile-visible"> <i class="fa  fa-phone"></i> </a>
            ...
            <div class="user-mobile-control">
               ...
               <div class="login">
			   <a href="#" class="location-icon"> <i class="fa  fa-map-marker"></i> </a>
                   
				   
			   		<?php if($this->session->userdata('student_session_login') == 1){ ?>
						<a href="<?php echo base_url().'studentsection' ?>"  class="login-user"  > <i class="fa  fa-user"></i></a> 
						<?php } else {  ?>
