...
<!-- <header class="main-header">
    ...
    <header class="main-header payment-header">
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-sm-6 col-lg-8">
        <h1 class="title-h"><a href="<?php echo $this->query_model->getBaseUrl(); ?>" target="_blank"><?= $settings->title; ?></a><span class="title-sub hidden-xs"><?php $this->query_model->getStrReplace($settings->h1_tag); ?>
                    </span></h1>
		</div>
      <div class="col-md-4 col-sm-6 col-lg-4 ">
        <h2 class="contact-top">
          <!-- <span class="accent-text ">6 LOCATIONS IN MEMPHIS</span> -->
                    <?php if($multilocation == 1){ ?>
					<?php $this->query_model->getStrReplace($settings->top_bar_text); ?>
				<?php } else{  ?>
					<i class="fa fa-phone"></i>
