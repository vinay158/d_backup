...
$virtual_training_rows = $this->query_model->getbyTable('tbl_virtual_training_rows');
         ...
         <div class="container-fluid">
			...
			<?php if($settings->ss_login_btn_position == "header"){ ?>
				...
				<?php }  ?>
					...
					<?php if($virtual_training[0]->hide_virtual_classes_button == 0 && !empty($virtual_training_rows)){ ?>
