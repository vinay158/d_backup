						  ...
						  function drawChart() {
						   ...
						   dataTable.addColumn({ type: 'string', role: 'tooltip' });
						    ...
						    dataTable.addRows([
						      ...
						      [ 'ATA History', 'Grand Master Lee creates and introduces the Songahm Taekwondo cirriculum', 'Grand Master Lee creates and introduces the Songahm Taekwondo cirriculum', new Date(1983, 1, 1), new Date(1986, 1, 1) ],
	...
	<form action="<?php echo $form_action_url; ?>"  method="post" class="get_started_form mini_form mini_trial_offer_form small_mini_form" id="form_7">
				...
				<?php } ?>
					...
					<?php if($multiSchoolOrLocation == 0){ ?>
					 ...
					 <button class="btn-red contactFormSubmit_7 <?php echo $goBtnClass; ?>" name="submitEmail" value="submitEmail" type="submit" >GO</button>
