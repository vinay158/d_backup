...
<?php
	...
	$contact_slug = $this->query_model->getbySpecific('tblmeta', 'id', 21);
...
<section class="success">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <h2><?php echo (isset($result) && $result == 1) ? $this->query_model->getStaticTextTranslation('success') : $this->query_model->getStaticTextTranslation('failed'); ?></h2>
        </div>
      </div>
    </div>
  </section>
               ...
               <div class="col-md-10 col-md-push-1">
                  <div class="upgrade-block">
                   <?php 
						...
						$this->query_model->getDescReplace($thankyou_msg);
						}
					?>
				   
				   <p>
				   <?php if(isset($result) && $result == 0){ echo $error_msg;  } ?>
				   </p>
                  </div>
