...
vinay kumar verma<?php echo '<pre>'; print_r($error_message); die; ?>
<script>
function goBack() {
    window.history.back();
}
    ...
    <div class="row">
      ...
      <div class="col-sm-12 text-center"> <span class="no"></span>
        ...
        <div class="row">
         ...
         <!--<a class=" btn btn-difalt btn btn-theme backbutton" onclick="goBack()" > BACK TO HOMEPAGE  </a>-->
		 <button type="button" class="btn btn-danger backbutton">BACK TO HOMEPAGE</button>
