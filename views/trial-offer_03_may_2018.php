      ...
      <div class="row">
         <div class="col-md-12 text-center">
            ...
            <div class="started-block">
               ...
               <form action="#"  method="post" class="get_started_form mini_form mini_trial_offer_form    small_mini_form" id="form_8">
      ...
      <div class="row">
         <div class="col-md-12 text-center">
            ...
            <div class="started-block">
               ...
               <form action="#"  method="post" class="get_started_form mini_form mini_trial_offer_form small_mini_form" id="form_6">
                  <div class="search-box">
				   <?php if($multiSchoolOrLocation == 1 ){ ?>
				   <?php if($multiLocation[0]->field_value == 1  && count($form_allLocations) >= 1){ ?>
