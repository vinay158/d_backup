...
<section id="program-main" class="program-trial-form">
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4 col-md-4 text-span4 hidden-xs mobile-tab-hidden ">
        ...
        <div class="program-desc">
          ...
          <p>Karate for Kids will help your child develop essential skills that they can apply to all areas of life.</p>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-4 form-schedule form-span4 ">
        <div class="program-trial">
          <div class="red-block text-center">
            <h2>ATA Tigers <br/> exclusive Web Offer</h2>
            <h1>Act Now</h1>
            <p>Limited Spots Available<br> Limited Time Offer</p>
            <div class="big_triangle_wrapper">  
      <div class="big_triangle"></div>  
      </div>
          </div>
          <div class="white-block redeem-offer-block">
          <h2>Join Our Confidence Building
            Martial Arts Classes
            In Bentonville, Ar</h2>
      ...
      <div class="col-sm-4 col-md-4 text-span4 hidden-lg hidden-sm hidden-md mobile-tab-visible ">
        <img src="images/logo-white.png">
        <div class="program-desc">
          <h2  style="background-color: rgba(0,0,0,0.5);padding: 15px;">Helping Parents Raise Confident Leaders</h2>
          <p>Karate for Kids will help your child develop essential skills that they can apply to all areas of life.</p>
...
<section id="life-skills">
  <div class="container">
    <div class="row">
      <h2>ATA Karate For Kids Teaches Life Skills</h2>
      <div class="col-sm-4">
            ...
            <div class="row">
               <div class="col-md-8 col-md-push-2">
                  ...
                  <div class="player-inner">
                    <iframe  height="390" src="https://www.youtube.com/embed/Pu5p1kDbR9I?rel=0&amp;controls=0&amp;showinfo=0&amp;autoplay=0" frameborder="0" allowfullscreen ></iframe>
                  </div>
               </div>
            </div>
         </div>
...
<section id="toggle-block" class="clearfix blue-bg share-section">
         <div class="content-box">
          ...
          <p><b>We teach the same values you teach at home, in a positive, safe & fun environment. </b></p>
...
<section class="difference-block" id="difference">
         <span class="overlay"></span>
         <div class="container">
            <div class="row text-center">
               <div class="col-sm-12 col-md-12">
                  <div class="text-center">
                     <h2>What Makes Fayetteville ATA Martial Arts Different From other<br> Karate &amp; Taekwondo Schools?</h2>
                  </div>   
               ...
               <div class="col-md-12">
                  <p class="lead"> As the largest martial arts organization in the country, since 1969, ATA Martial Arts has successfully guided 1 million members on their martial arts journey by providing them a blueprint for success:</p>
               </div>
            </div>
         </div>
      </section>
            ...
            <div class="row">
               <div class="col-md-12 col-sm-12">
                  ...
                  <div class="col-md-10 col-md-push-1 col-sm-12 stats">
                    <h2>DO NOT LET YOUR CHILD BECOME A STATISTIC. </h2>
      ...
      <section id="life-skills" class="ways sky-bg">
        <div class="container">
          <div class="row">
            <h2>3 Ways Our Kids Martial Arts Classes<br>Help Your Child <b> Reach Their Potential:</b></h2>
            <div class="col-sm-4">
...
<section id="get-started" class="gift">
<span class="overlay"></span>
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <p>This is a limited time offer! Only 25 total spots are available.</p>
      </div>
      <div class="col-sm-4">
        <img src="images/reedem.png">
 ...
 <section class="trial-form trial-form-about-footer" id="trial-program">
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-center">
                  <h2>ATA Karate For Kids exclusive Web Offer</h2>
                  <h1> Act Now!</h1>
                  <p>Limited Spots Available<br>Limited Time Offer</p>
                  <h3>Join Our Confidence Building Martial Arts Classes In Bentonville, Ar</h3>
               </div>
            </div>
         </div>
      </section>
