      ...
      <div class="col-md-4 col-sm-4 form-schedule form-span4 ">
        <div class="program-trial">
          <div class="red-block text-center">
            <h1>Kids Programs<br><strong>Exclusive Web Offer</strong></h1>
            <h2>Act Now</h2>
...
<section id="program-top">
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <h2>Some Title Here</h2>
        <p>Diam nonummy nibh euismod tincidunt ut laoreet dolore magna. Etiam processus dynamicus qui sequitur mutationem consuetudium lectorum.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="learn-goal" class="gray-bg ">
  <div class="container">
    <div class="row">
      <div class="col-md-10 col-md-push-1">
        <div class="row">
          <div class="col-md-4 img-over">
            <img src="images/goal.png" style="margin-top:3px;">
          </div>
          <div class="col-md-8">
            <div class="programs-text-block">
            <h2>ATA Tigers</h2>
            <h3>3-6 Year Olds</h3>
            <p>The best martial arts program for kids, ever.
Allows children to feel engaged with our martial arts program by providing strong visual cues to help them align with their achievements and goals. Uses the cartoon tiger characters to provide a relational point students can identify, each character symbolizing a value that is a foundation of the martial arts.</p>
            <div class="program-btn-block">
              <a href="#" class="load-more">Learn more</a>
              <a href="#" class="follow-btn">View Schedule</a>
            </div>
          </div>
          </div>
        </div>
      ...
      <div class="col-md-10 col-md-push-1">
        <div class="row">
          ...
          <div class="col-md-4 img-over col-md-push-8">
            <img src="images/focus.png" style="margin-top:-15px;">
          </div>
          <div class="col-md-8 col-md-pull-4">
                        <div class="programs-text-block">
            <h2>Karate for Kids</h2>
            <h3>7-12 Year Olds</h3>
            <p>he best martial arts program for kids, ever. Allows children to feel engaged with our martial arts program by providing strong visual cues to help them align with their achievements and goals. Uses the cartoon tiger characters to provide a relational point students can identify, each character symbolizing a value that is a foundation of the martial arts.</p>
            <div class="program-btn-block">
              <a href="#" class="load-more">Learn more</a>
              <a href="#" class="follow-btn">View Schedule</a>
            </div>
