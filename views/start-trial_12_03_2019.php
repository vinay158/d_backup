                  ...
                  <!--<div class="player-inner"> -->
				   <?php if($trial_offer_cat->video_type == 'youtube_video'){ ?>
						<?php if(!empty($trial_offer_cat->youtube_video)){ ?>
							  ...
							  <div class="video-inner">
									 <iframe  height="390" src="<?php echo $trial_offer_cat->vimeo_video; ?>?rel=0&amp;controls=0&amp;showinfo=0&amp;autoplay=0" frameborder="0" allowfullscreen ></iframe>
									 <span class="video-overlay">
										<div class=""></div>
									 </span>
								  </div>
...
<script>
	...
	$(document).ready(function(){
	   ...
	   <form action="starttrial/buyspecial" method="get" class="trialform" id="my-payment-form">
      <section id="step-form">
		...
		<div class="col-md-12 col-sm-12">
         ...
         <div class="col-md-6 col-sm-6">
           ...
           <div class="col-md-6 col-sm-6">
			...
			<?php  if(count($all_programs) > 1){ ?>
			   <div class="<?php echo ($multiLocation[0]->field_value == 1  && count($allLocations) >= 1) ?  'col-md-6 col-sm-6' : 'col-md-12 col-sm-12'?>">
				<div class="form-group">
				<select class="form-control"  name="program_id" id="program1">
		 ...
		 <?php if($multiLocation[0]->field_value == 1  && count($allLocations) >= 1){ ?>
		   <div class="col-md-6 col-sm-6">
			<div class="form-group">
            <select class=" form-control" name="location_id" id="school">
			...
			?>
                        ...
                        <!--<div class="col-md-12 col-sm-12">
                           <div class="form-group">
                            ...
                            <div class="terms position-relative">
                              <input type="checkbox"  name="term_condition" id="term_condition" value="1" > I agree to terms and conditions
                            </div>
                           </div>
                        </div> -->
		 ...
		 <div class="form-group">
				<?php if($this->query_model->get_gdpr_compliant() == 1){?>
				 ...
				 <?php } ?>
		  		...
		  		<input type="hidden" name="trial_offer_cat_id" value="<?php echo $trial_offer_cat->id ?>" />
            	...
            	<input type="submit" name="submit" id=""  class="btn-blue btn-block submitOfferTrial" value="<?php echo $this->query_model->getStaticTextTranslation('get_started'); ?>"  disabled>
	 ...
	 <input type="hidden" name="hid_location" value="<?= !empty($contactDetail) ? $contactDetail->id : '' ?>" />
	  <div class="message">
	    ...
	    <div style="position:relative;">
          ...
          <input type="text" name="name" id="first_name1"  class="contact-form-line" placeholder="<?php echo $this->query_model->getStaticTextTranslation('first_name'); ?>" onFocus="this.placeholder = ''"   onBlur="textAlphabatic(this)" maxlength="25" error_class="name_error1" error_msg="<?php echo $this->query_model->getStaticTextTranslation('enter_your_first_name'); ?>" >
