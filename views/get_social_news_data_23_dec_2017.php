 ...
 <div class="container">
	...
	<div class="col-md-12">
	  ...
	  <div class="social-list" id="social-news">
            ...
            <div class="content-social">
             <?php if(!empty($googlePlus['object']['attachments'])){ ?>
              ...
              <div class="<?php if(!empty($googlePlus['object']['attachments'])){ echo 'txt'; } else { echo 'padding-set';} ?>">
				...
				<?php if(!empty($googlePlus['object']['attachments'])){ ?>
                <a href="<?php echo $googlePlus['object']['attachments'][0]['url']; ?>" target="_blank">Read More</a>
				<?php }else{ ?>
				<a href="<?php echo $googlePlus['url']; ?>" target="_blank">Read More</a>
				<?php } ?>
			 </div>
              <div class="user">
		...
		?>
          <li class="social_items <?= $hidePosts; ?>  facebook posts_<?= $c ?>" number="<?= $c ?>"  data-category="facebook">
            <div class="content-social">
               <!--- jiten 2 sep Start-->
             <?php if(isset($facebooks['attachments']['data'][0]['media']['image']['src'])){ ?>
			   <div class="img-s">
			  	 <img src="<?php echo $facebooks['attachments']['data'][0]['media']['image']['src']; ?>" class="img-responsive fancybox"  data-fancybox-group="gallery" title="<?php echo $facebooks['from']['name']; ?>" style="min-height:130px;">
				</div>
			 <?php }elseif(isset($facebooks['attachments']['data'][0]['subattachments']['data'][0]['media']['image']['src'])){ ?>
			 			<div class="img-s">
			 			 <img src="<?php echo $facebooks['attachments']['data'][0]['subattachments']['data'][0]['media']['image']['src']; ?>" class="img-responsive fancybox"  data-fancybox-group="gallery" title="<?php echo $facebooks['from']['name']; ?>" style="min-height:130px;">
						</div>
			 <?php } ?>
			 ...
			 <!--- jiten 2 sep End-->
              ...
              <div class=" <?php  if(isset($facebooks['attachments']['data'][0]['media']['image']['src']) || isset($facebooks['attachments']['data'][0]['subattachments']['data'][0]['media']['image']['src'])){ echo 'txt'; }else{ echo 'text padding-set'; } ?>">
				...
				?></p>
                <a href="<?php if(isset($facebooks['link'])){ echo $facebooks['link']; }elseif(isset($facebooks['attachments']['data'][0]['target']['url'])){ echo $facebooks['attachments']['data'][0]['target']['url']; } else { echo 'https://www.facebook.com/'.$facebooks['from']['id'];} ?>" target="_blank">Read More</a> </div>
              <div class="user">
          ...
          <li class="social_items <?= $hidePosts; ?>  youtube posts_<?= $d ?>" number="<?= $d ?>"  data-category="youtube">
             <div class="content-social">
              ...
              <div class="txt">
                ...
                <a href="<?php echo 'https://www.youtube.com/watch?v='.$youtube_video['video_id']; ?>" target="_blank">Read More</a> </div>
              <div class="user">
		...
		?>
          <li class="social_items <?= $hidePosts; ?>  ALL posts_<?= $c ?>" number="<?= $c ?>"  data-category="facebook" date_filter="<?php echo strtotime($facebooks['created_time']); ?>">
