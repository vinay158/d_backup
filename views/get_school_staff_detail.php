      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="staff-bio-detail">
            <img  src="<?php base_url(); ?>upload/school_staff/<?= $staffDetail[0]->lightbox_photo; ?>" alt="<?= $this->query_model->getStrReplace($staffDetail[0]->lightbox_photo_alt_text); ?>"  class="img-responsive">
