...
<link rel="stylesheet" type="text/css" href="lightbox/jquery.fancybox.css?v=2.1.5" media="screen" />
         ...
         <div class="container">
            <div class="row">
                   ...
                   <div class="row">
                     <div class="col-sm-6 col-md-5">
                       ...
                       <h2><?php if(!empty($schoolHeader) && !empty($schoolHeader[0]->opt1_title)) {
								$this->query_model->getDescReplace($schoolHeader[0]->opt1_title); 
					  }else{
                       ...
                       <p><?php if(!empty($schoolHeader) && !empty($schoolHeader[0]->opt1_text)) {
								$this->query_model->getDescReplace($schoolHeader[0]->opt1_text); 
					  }?></p>
                     </div>
				...
				<?php } ?>  
					...
					<?php if($this->query_model->get_gdpr_compliant() == 1){?>
                     ...
                     <button class="view-offer contactFormSubmit_6" name="submitEmail" value="submitEmail" type="submit" ><?php if(!empty($schoolHeader) && !empty($schoolHeader[0]->opt1_btn_text)) {
								$this->query_model->getDescReplace($schoolHeader[0]->opt1_btn_text); 
               ...
               <div class="col-md-12 col-sm-12">
                  <h2><?php $this->query_model->getDescReplace($schoolHeader[0]->title);  ?></h2>
                  <p><?php $this->query_model->getDescReplace($schoolHeader[0]->description);  ?></p>
                 <!-- <ul>
                  ...
                  <div class="action-btn">
                     ...
                     <?php if($schoolHeader[0]->buttons == '1_button'){ 
                        ...
                        ?>
                     <a href="<?php echo $linkurl_single; ?>"  target="<?php echo $schoolHeader[0]->button1_link_target; ?>" class="<?php echo isset($schoolHeader[0]->button1_button_class) ? $schoolHeader[0]->button1_button_class : ''; ?> left  action-control"><?php echo $schoolHeader[0]->button1_text; ?> <i class="fa  fa-angle-right"></i></a> 
                     <?php } ?>
	...
	<?php if(!empty($schoolHeader[0]->header_summery)){ ?>
      <section id="school-quote">
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
              <p><?php $this->query_model->getDescReplace($schoolHeader[0]->header_summery);  ?></p>
            </div>
          </div>
        </div>
      </section>
	<?php } ?>	
      ...
      <section class="ads feature-program clearfix school-owner-about" id="feature-new" >
         <div class="container">
            <div class="row">
               <div class="col-md-4">
                  <div class="relative" >
                     <img src="<?php echo base_url().'upload/school_about_us/'.$aboutContent[0]->photo; ?>" class="img-responsive school-owner-a" style="top:<?php echo !empty($aboutContent[0]->img_top_spacing) ? $aboutContent[0]->img_top_spacing : 0; ?>px;" alt="<?php $this->query_model->getDescReplace($aboutContent[0]->image_alt);  ?>">
                  </div>
               </div>
               <div class="col-md-8 col-sm-8 owner-info">
                  <h3><?php $this->query_model->getDescReplace($aboutContent[0]->title);  ?></h3>
                  <h2><?php $this->query_model->getDescReplace($aboutContent[0]->sub_title);  ?></h2>
                  <p><?php $this->query_model->getDescReplace($aboutContent[0]->description);  ?></p>
	  ...
	  <?php if($contactDetail->school_location_type == "default" && $contactDetail->turn_on_nested_location == 1){ ?>
    ...
    <div class="inline_mid_form ">
        <select id="nested-child-locations"  class="contact-form-line">
            <option value="">--Select Location--</option>
			<?php if(!empty($child_locations)){
				foreach($child_locations as $child_location){ 
					echo '<option value="'.$child_location->id.'">'.$child_location->name.'</option>';
				}
			} ?>
            </select> 
		</div>
			...
			?>
                <div class="col-md-4">
					...
					<?php if(!empty($program->featured_program_img)){ ?>
                        <img class="img-responsive"  src="<?php echo base_url().'upload/programs/'.$program->featured_program_img; ?>"  alt="<?= $this->query_model->getDescReplace($program->featured_program_img_alt_text); ?>">
					<?php } ?>
                        <figcaption>
                            <h2><?php $this->query_model->getDescReplace($program->program);  ?></h2>
                            <h3><?php $this->query_model->getDescReplace($program->ages);  ?></h3>
                            <p><a href="<?php echo base_url().$program_slug.'/'.$category_detail[0]->cat_slug.'/'.$program->program_slug; ?>"><?php echo $this->query_model->getStaticTextTranslation('learn_more'); ?></a></p>
	...
	<?php } ?>
      ...
      <section class="getting-started-school">
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
              <h2><?php $this->query_model->getDescReplace($schoolTextSection[0]->getting_started_title);  ?></h2>
            </div>
          </div>
        </div>
      </section>
         ...
         <div class="container-fluid">
                         <div class="row">
                           <div class="col-sm-4">
                             ...
                             <h3><?php $this->query_model->getDescReplace($schoolTextSection[0]->getting_started_box_1_text);  ?></h3>
                           </div>
                           <div class="col-sm-4">
                             <div class="icon">2</div>
                             <h3><?php $this->query_model->getDescReplace($schoolTextSection[0]->getting_started_box_2_text);  ?></h3>
                           </div>
                           <div class="col-sm-4">
                             <div class="icon">3</div>
                             <h3><?php $this->query_model->getDescReplace($schoolTextSection[0]->getting_started_box_3_text);  ?></h3>
                           </div>
                         </div>
                       </div>
      </section>
               ...
               <div class="col-md-8 col-md-push-2">
				  ...
				  <?php } } ?> 
					 <?php } else { ?>
							...
							<img class="img-responsive center-block" src="<?php echo base_url().'upload/school_about_us/'.$schoolVideoSection[0]->photo; ?>"  alt="<?= $this->query_model->getDescReplace($schoolVideoSection[0]->image_alt); ?>" />
							<?php } ?>
					 
					 <?php } ?>
					 
                  <div class="video-blcok text-center">
                     <h2><?= $this->query_model->getStrReplace($schoolVideoSection[0]->title); ?></h2>
                     <p><?= $this->query_model->getStrReplace($schoolVideoSection[0]->sub_title); ?></p>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="col-md-12 col-sm-12">
                  <div class="text-center">
					 ...
					 if(!empty($schoolTextSection[0]->timeline_title)){
						$this->query_model->getDescReplace($schoolTextSection[0]->timeline_title);
					 }else{
            ...
            <div class="row">
               <div class="col-md-12 text-center">
                  <h2> <?php if(!empty($schoolHeader) && !empty($schoolHeader[0]->opt_2_title)) {
						$this->query_model->getDescReplace($schoolHeader[0]->opt_2_title); 
				  }else{
                  ...
                  <p><?php if(!empty($schoolHeader) && !empty($schoolHeader[0]->opt_2_text)) {
						$this->query_model->getDescReplace($schoolHeader[0]->opt_2_text); 
				  }  ?></p>
  ...
  <div class="container">
    ...
    <div class="row">
		...
		$('.contactFormSubmit1').click(function(){
         ...
         <form action="<?=base_url().$trial_offer_slug->slug?>"  method="post" class="get_started_form mini_form_2">
          <div class="inline_mid_form " >
           ...
           <div class="inline_mid_form display_none_lname" >
	  ...
	  <?php } } ?>
	   ...
	   <?php 
			//if(!empty($ourStaffs)){
				$display_staff_list = ($contactDetail->school_location_type == "default" && $contactDetail->turn_on_nested_location == 0) ? 'block' : 'none';
		?>
      <section id="staff" style="display:<?php echo $display_staff_list; ?>">
         <div class="container">
            <div class="row">
               <div class="col-sm-12 col-md-12">
...
<?php } ?>
	...
	<?php 
		if(!empty($contactDetail)){
			$display_school_detail = ($contactDetail->school_location_type == "default" && $contactDetail->turn_on_nested_location == 0) ? 'block' : 'none';
	?>
      <section id="school-location" style="display:<?php echo $display_school_detail; ?>">
       <div class="container">
           <div class="row">
	 ...
	 <input type="hidden" name="hid_location" value="<?= !empty($contactDetail) ? $contactDetail->id : '' ?>" />
	  <div class="message">
        ...
        <div style="position:relative;">
          ...
          <span class="fa fa-user form-control-feedback move_input_icon site_theme_text" aria-hidden="true"></span> </div>
          <div style="position:relative;" class="display_none_lname">
...
<script>
	$(document).ready(function(){
		$('body').on('click','.staffInfoPopUp',function(){
			var number = $(this).attr('number');
		...
		$('#nested-child-locations').change(function(){
			
			var location = $(this).val();
			$('#school-location').show();
			$('#school-location').html('');
			$('#staff').html('');
			
			if(location != '' && location != null){
				$.ajax({
				
						url: "<?=base_url();?>schools/get_school_location_detail",
				...
				$.ajax({
						...
						url: "<?=base_url();?>schools/get_instructors_list",
