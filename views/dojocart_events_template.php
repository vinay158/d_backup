...
<section id="payment-block" class="dojocart_page">
  <div class="container-fluid paymentBlockPart">
    ...
    <div class="media-body">
			...
			?>
			<p><?php echo $this->query_model->getStaticTextTranslation('event_date'); ?>: <?php echo $tournamentDate; ?></p>
			<p><?php echo $this->query_model->getStaticTextTranslation('event_time'); ?>: <?php echo $tournamentTime; ?></p>
          </div>
...
?>
  ...
  <div class="col-md-12 col-sm-12">
				<div class="form-group">
				<textarea name="additional_info" class="form-control" cols="100" placeholder="<?php echo $this->query_model->getStaticTextTranslation('additional_info'); ?>
"></textarea>
			</div>
		</div>	
          <div class="clearfix"></div>
		...
		?>
          <div class="col-md-12 col-xs-12" style="display:<?php echo $qtyDisplay; ?>">
            <div class="offer-block">
                 <div class="quantity">
                  <label><?php echo $this->query_model->getStaticTextTranslation('number_of_attendees'); ?>
</label>
